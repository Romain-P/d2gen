package com.ankamagames.tiphon.display
{
   ...
   public class TiphonSprite extends Sprite implements IAnimated, IAnimationSpriteHandler, IDestroyable, EntityLookObserver
   {
      ...
      public function TiphonSprite(look:TiphonEntityLook)
      {
         ...
         this._animationModifier = new Array();
         ...
         if(skinList)
         {
            ...
            for(i = 0; i < num; i++)
            {
               skin = uint(skinList[i]);
               skin = uint(this._skin.add(skin,this._alternativeSkinIndex));
            }
         }
      ...
      public function setAnimationAndDirection(animation:String, direction:uint, pDisableAnimModifier:Boolean = false) : void
      {
         ...
         var cat:* = null;
         var subEntity:* = null;
         var newAnimationName:* = null;
         var modifier:* = null;
         var te:* = null;
         var transitionalAnim:* = null;
         var boneFileUri:* = null;
         if(this.destroyed)
         {
            return;
         }
      ...
      public function getGlobalScale() : Number
      {
         ...
         {
            globalScale = Number(globalScale * (!!currentParentSprite._animMovieClip?currentParentSprite._animMovieClip.scaleX:1));
      ...
      protected function render() : void
      {
         ...
         var dirs:* = null;
         var dir:* = undefined;
         var rasterizedSyncAnimation:* = null;
         var sprite:* = null;
         var pos:* = null;
         var subEntityInfo:* = null;
         var tiphonSprite:* = null;
         var animList:* = null;
         var subEntityAnimation:* = null;
         var l:int = 0;
         var animName:* = null;
         var i:int = 0;
         if(this.destroyed)
         ...
         if(animClass == null)
         {
            ...
            defaultOrientation = uint(this._currentDirection);
            if(defaultAnimation)
            {
               ...
               for(dir in dirs)
               {
                  if(dirs[dir])
                  {
                     defaultOrientation = uint(int(dir));
                     break;
                  }
               }
            }
      ...
      {
         var carriedSprite:* = null;
         var child:* = null;
         var splitedName:* = null;
         this.updateScale();
         ...
         if(this._isCarrying && this._carriedEntity)
         {
            if(carriedSprite)
            {
               this._carriedEntity.x = 0;
               this._carriedEntity.y = 0;
