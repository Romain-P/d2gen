package com.ankamagames.tubul.types.sounds
{
   ...
   public class LocalizedSound extends MP3SoundDofus implements ILocalizedSound
   {
      ...
      public function set position(position:Point) : void
      {
         ...
         if(_uri)
         {
            filname = _uri.fileName;
         }
         this._position = position;
         if(this._observerPosition && _uri.fileName != "40003440001.mp3" && _uri.fileName != "1000001197.mp3" && _uri.fileName != "1000001198.mp3" && _uri.fileName != "1000001199.mp3" && _uri.fileName != "1000001200.mp3" && _uri.fileName != "1000001201.mp3" && _uri.fileName != "40004106001.mp3" && _uri.fileName != "1000001254.mp3" && _uri.fileName != "1000001255.mp3" && _uri.fileName != "1000001256.mp3" && _uri.fileName != "1000001257.mp3" && _uri.fileName != "1000001258.mp3" && _uri.fileName != "1000001259.mp3" && _uri.fileName != "1000001260.mp3" && _uri.fileName != "1000001261.mp3" && _uri.fileName != "1000001262.mp3" && _uri.fileName != "1000001263.mp3" && _uri.fileName != "1000001264.mp3" && _uri.fileName != "1000001265.mp3")
         {
            this.updateSound();
         }
      }
