package com.ankamagames.tubul
{
   ...
   public class Tubul extends EventDispatcher
   {
      ...
      public function get totalPlayingSounds() : uint
      {
         ...
         {
            sounds = uint(sounds + bus.soundList.length);
         }
         return sounds;
      }
      ...
      private function onPropertyChanged(e:PropertyChangeEvent) : void
      {
         ...
         {
            case "muteMusic":
               this.setVolumeToBus(0,!!e.propertyValue?0:uint(this._tuOptions.volumeMusic));
               break;
            case "muteSound":
               this.setVolumeToBus(4,!!e.propertyValue?0:uint(this._tuOptions.volumeSound));
               break;
            case "muteAmbientSound":
               this.setVolumeToBus(1,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(2,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(3,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(5,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(6,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               this.setVolumeToBus(7,!!e.propertyValue?0:uint(this._tuOptions.volumeAmbientSound));
               break;
            case "volumeMusic":
