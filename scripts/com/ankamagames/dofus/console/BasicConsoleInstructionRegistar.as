package com.ankamagames.dofus.console
{
   ...
   public class BasicConsoleInstructionRegistar implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(console:ConsoleHandler) : void
      {
         ...
         console.addHandler(["uiinspector","inspectuielement","autoreloadui","loadui","unloadui","clearuicache","resetuisavedusermodification","getthemefingerprint","clearthemedata","clearcsscache","cleartooltipcache","useuicache","uilist","reloadui","modulelist","debugwebreader","subhint"],new UiHandlerInstructionHandler());
