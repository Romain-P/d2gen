      ...
      public function handle(console:ConsoleHandler, cmd:String, args:Array) : void
      {
         ...
         switch(cmd)
         {
            ...
            case "showeverycellid":
               Atouin.getInstance().options.showEveryCellId = !Atouin.getInstance().options.showEveryCellId;
               console.output("showEveryCellId : " + Atouin.getInstance().options.showEveryCellId);
               InteractiveCellManager.getInstance().showEveryCellId(Atouin.getInstance().options.showEveryCellId);
               break;
            case "playerjump":
