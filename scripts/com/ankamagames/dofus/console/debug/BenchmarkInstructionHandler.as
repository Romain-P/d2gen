package com.ankamagames.dofus.console.debug
{
   ...
   public class BenchmarkInstructionHandler implements ConsoleInstructionHandler
   {
      ...
      public function handle(console:ConsoleHandler, cmd:String, args:Array) : void
      {
         ...
         var typeZone:int = 0;
         var showFightZone:Boolean = false;
         var showInteractiveCells:Boolean = false;
         var showTacticMode:Boolean = false;
         var showScalezone:Boolean = false;
         var flattenCells:Boolean = false;
         var showBlockMvt:Boolean = false;
         var rnd:* = null;
         var i:int = 0;
         var rpCharEntity:* = null;
         var cell:* = null;
         var emote:* = null;
         var name:* = null;
         var param:* = null;
         var fightEntity:* = null;
         var gfmi:* = null;
         var fr:* = null;
         var chatind:int = 0;
         var time:int = 0;
