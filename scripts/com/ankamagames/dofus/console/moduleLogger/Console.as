   ...
   public final class Console
   {
      ...
      private function createWindow() : void
      {
         ...
         if(!this._window)
         {
            ...
            this._window.width = !this._chatMode?800:Number(600);
            this._window.height = !this._chatMode?600:Number(400);
      ...
      private function updateWordWrapLines() : void
      {
         ...
         var lastIndex:int = 0;
         var tsText:* = null;
         var tmpLineText:* = null;
         var tmpReplaceText:* = null;
