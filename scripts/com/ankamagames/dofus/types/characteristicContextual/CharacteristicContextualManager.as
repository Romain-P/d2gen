      ...
      private function onScroll(e:Event) : void
      {
         ...
         for(index in _aEntitiesTweening)
         {
            ...
            if(tweenData)
            {
               ...
               else if(tweenData._tweeningCurrentDistance < 0.125)
               {
               ...
               else if(tweenData._tweeningCurrentDistance < 0.25)
               {
                  entity.alpha = tweenData._tweeningCurrentDistance * 4;
                  if(this._type == 2)
                  {
               ...
               else if(tweenData._tweeningCurrentDistance >= 0.75 && tweenData._tweeningCurrentDistance < 1)
               {
