package com.ankamagames.dofus.types.entities
{
   ...
   public class AnimatedCharacter extends TiphonSprite implements IEntity, IMovable, IDisplayable, IAnimated, IInteractive, IRectangle, IObstacle, ITransparency, ICustomUnicNameGetter
   {
      ...
      public function move(path:MovementPath, callback:Function = null, movementBehavior:IMovementBehavior = null) : void
      {
         ...
         var forbidenCellsId:* = null;
         var rpContextFrame:* = null;
         var ies:* = null;
         var ie:* = null;
         var mp:* = null;
         var iePos:int = 0;
         var avaibleDirectionCount:* = 0;
         var endpoint:* = null;
         var followerPoint:* = null;
         var tryCount:int = 0;
         var followedMovPath:* = null;
         var firstDrawPath:* = null;
         var followerPath:* = null;
         var i:int = 0;
         var storedMovementPath:* = null;
         var pElem:* = null;
         ...
         {
            avaibleDirectionCount = uint(this.getFollowerAvailiableDirectionNumber(follower));
            endpoint = path.end;
      ...
      override public function removeSubEntity(entity:DisplayObject) : void
      {
         ...
         if(this._auraEntity && tiphonSprite && this._auraEntity.look.toString() == tiphonSprite.look.toString())
         {
            this._auraEntity = null;
         }
