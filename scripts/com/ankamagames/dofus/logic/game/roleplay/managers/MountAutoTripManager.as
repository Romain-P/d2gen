package com.ankamagames.dofus.logic.game.roleplay.managers
{
   ...
   public final class MountAutoTripManager
   {
      ...
      private var _currentRoute:Vector.<Edge#156>;
      ...
      public function startNextTripStage(mapId:Number) : void
      {
         ...
         if(mapId != nextEdge.from.mapId)
         {
            ...
            _log.debug("La map actuelle n\'est pas celle prévue, annulation du voyage");
            this.endTrip(false);
            return;
         }
      ...
      private function onRouteFound(path:Vector.<Edge#156>) : void
      {
         var e:* = null;
         var destMapName:* = null;
         var currentRouteText:* = null;
         Berilia.getInstance().unloadUi(this._popupName,true);
         if(!this._routeCalculating)
         {
      ...
      {
         var transitionToUse:* = null;
         var transitionCellId:int = 0;
         var adjacentMapClickMessage:* = null;
         var cellClickMessage:* = null;
         var interactiveElementToActivate:* = null;
         var elementPosition:* = null;
         var elementSkillInstanceId:int = 0;
         var interactiveElementActivationMessage:* = null;
