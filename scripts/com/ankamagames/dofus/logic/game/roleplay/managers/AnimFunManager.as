package com.ankamagames.dofus.logic.game.roleplay.managers
{
   ...
   public final class AnimFunManager
   {
      ...
      public function initializeByMap(mapId:Number) : void
      {
         ...
         for(i = 0; i < ANIM_DELAY_SIZE; )
         {
            ...
            if(this.hasAnimsFun(actorId))
            {
               ...
               if(!isFastAnim)
               {
                  animdelayTime = uint(rnd.nextIntR(ANIM_FUN_TIMER_MIN,ANIM_FUN_TIMER_MAX));
                  this._nbNormalAnims++;
               }
               else
               {
                  animdelayTime = uint(rnd.nextIntR(FAST_ANIM_FUN_TIMER_MIN,FAST_ANIM_FUN_TIMER_MAX));
                  this._nbFastAnims++;
               }
      ...
      private function checkAvailableAnim(pTimer:SynchroTimer) : void
      {
         ...
         var nbAnims:int = 0;
         var entity:* = null;
         var roleplayEntitiesFrame:* = null;
         var actorInfos:* = null;
         var cellData:* = null;
      ...
      private function randomAnim(actorId:Number, animSeed:int) : String
      {
         var list:* = null;
         var groupMonsterInfo:* = null;
         var monster:* = null;
         var npcInfo:* = null;
         var npc:* = null;
