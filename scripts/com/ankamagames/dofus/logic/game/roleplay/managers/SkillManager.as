package com.ankamagames.dofus.logic.game.roleplay.managers
{
   ...
   public class SkillManager
   {
      ...
      {
         var skill:* = null;
         var skillNameStr:* = null;
         var interactiveSkill:* = null;
         var disabledSkills:* = null;
         var collectSkill:* = null;
         ...
         for each(interactiveSkill in ie.enabledSkills)
         {
            ...
            enabledSkills = enabledSkills + (skillNameStr + "\n");
         }
         ...
         for each(interactiveSkill in ie.disabledSkills)
         {
            ...
            disabledSkills = disabledSkills + (skillNameStr + "\n");
         }
      ...
      {
         var skillNameStr:* = null;
         var enabledSkill:* = null;
         var skillDisabledData:* = null;
         var disabledSkill:* = null;
