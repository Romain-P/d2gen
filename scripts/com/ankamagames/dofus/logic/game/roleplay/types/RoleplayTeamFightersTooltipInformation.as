package com.ankamagames.dofus.logic.game.roleplay.types
{
   ...
   public class RoleplayTeamFightersTooltipInformation
   {
      ...
      public function RoleplayTeamFightersTooltipInformation(pFightTeam:FightTeam)
      {
         ...
         var taxCollectorLevel:* = 0;
         var firstName:* = null;
         var lastName:* = null;
         var taxCollectorName:* = null;
         var companionInfo:* = null;
         super();
         ...
         for(i = 0; i < len; )
         {
            ...
            switch(true)
            {
               ...
               case fightMemberInfo is FightTeamMemberMonsterInformations:
                  ...
                  monsterLevel = uint(monster.getMonsterGrade((fightMemberInfo as FightTeamMemberMonsterInformations).grade).level);
               ...
               case fightMemberInfo is FightTeamMemberTaxCollectorInformations:
                  taxCollectorLevel = uint((fightMemberInfo as FightTeamMemberTaxCollectorInformations).level);
