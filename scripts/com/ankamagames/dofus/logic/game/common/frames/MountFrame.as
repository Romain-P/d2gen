package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class MountFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var msrmsg:* = null;
         var mrra:* = null;
         var mountRenameRequestMessage:* = null;
         var msxrra:* = null;
         var msxrpmsg:* = null;
         var mira:* = null;
         var mirmsg:* = null;
         ...
         var mountToUpdate:* = null;
         var m:* = null;
         var meiuomsg:* = null;
         var mountSprite:* = null;
         var emtfpmsg:* = null;
         var takenMessage:* = null;
         var mremsg:* = null;
         var mhdra:* = null;
         var mhdrmsg:* = null;
         var mhcura:* = null;
         ...
         switch(true)
         {
            ...
            case msg is ExchangeHandleMountStableAction:
               ...
               for(vecLenght = uint(idsVector.length); vecLenght > 0; )
               {
                  if(vecLenght > ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT)
                  {
                     ...
                     vecLenght = uint(idsVector.length);
                  }
                  else
                  {
            ...
            case msg is ExchangeMountsStableRemoveMessage:
               ...
               {
                  for(i = 0; i < this._stableList.length; )
                  {
            ...
            case msg is ExchangeMountsPaddockRemoveMessage:
               ...
               {
                  for(i = 0; i < this._paddockList.length; )
                  {
