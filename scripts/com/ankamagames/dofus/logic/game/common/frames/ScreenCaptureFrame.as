package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class ScreenCaptureFrame implements Frame
   {
      ...
      {
         var b:* = null;
         var captureScreenShortcutKey:* = null;
         var captureScreenWithoutUiShortcutKey:* = null;
         var notifId:* = 0;
         ...
         if(!StoreDataManager.getInstance().getData(Constants.DATASTORE_COMPUTER_OPTIONS,"screenshotNotification") && PlayedCharacterManager.getInstance().infos.level >= MIN_LEVEL_NOTIFICATION)
         {
            ...
            notifId = uint(NotificationManager.getInstance().prepareNotification(I18n.getUiText("ui.common.screenshot"),I18n.getUiText("ui.common.screenshot.notification",[HtmlManager.addTag(captureScreenShortcutKey,HtmlManager.SPAN,{"color":XmlConfig.getInstance().getEntry("colors.shortcut")}),HtmlManager.addTag(captureScreenWithoutUiShortcutKey,HtmlManager.SPAN,{"color":XmlConfig.getInstance().getEntry("colors.shortcut")})]),NotificationTypeEnum.TUTORIAL));
      ...
      {
         var dir:String = OptionManager.getOptionManager("dofus")["screenshotsDirectory"];
         if(!dir)
         {
      ...
      private function onFileSelect(pEvent:Event) : void
      {
         ...
         {
            OptionManager.getOptionManager("dofus")["screenshotsDirectory"] = f.nativePath;
         }
      }
   }
}
