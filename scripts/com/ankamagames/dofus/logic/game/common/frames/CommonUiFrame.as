      ...
      public function process(msg:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case msg is CinematicMessage:
               ...
               KernelEventsManager.getInstance().processCallback(HookList.Cinematic,cm.cinematicId);
               return true;
            ...
            case msg is EntityTalkMessage:
               ...
               params = new Array();
               type = uint(TextInformationTypeEnum.TEXT_ENTITY_TALK);
               ...
               {
                  textId2 = uint(InfoMessage.getInfoMessageById(type * 10000 + etmsg.textId).textId);
                  if(param != null)
                  {
            ...
            case msg is ToggleWitnessForbiddenAction:
               option = uint(FightOptionsEnum.FIGHT_OPTION_SET_SECRET);
            ...
            case msg is ToggleLockPartyAction:
               option2 = uint(FightOptionsEnum.FIGHT_OPTION_SET_TO_PARTY_ONLY);
            ...
            case msg is ToggleLockFightAction:
               option3 = uint(FightOptionsEnum.FIGHT_OPTION_SET_CLOSED);
            ...
            case msg is ToggleHelpWantedAction:
               option4 = uint(FightOptionsEnum.FIGHT_OPTION_ASK_FOR_HELP);
