package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class ProtectPishingFrame implements Frame
   {
      ...
      private function onTextInput(te:TextEvent) : void
      {
         ...
         {
            len = uint(inputBuffer.length - _passwordLength + 1);
         ...
         {
            len = uint(this._globalBuffer.length - _passwordLength + 1);
         ...
         {
            len = uint(this._globalModBuffer.length - _passwordLength + 1);
