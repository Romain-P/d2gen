package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class EmoticonFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var spellLevelId:* = 0;
         var actor:* = undefined;
         var mEntityInfo:* = null;
         var tiphonMassiveLook:* = null;
         var emo:* = null;
         var mAnim:* = null;
         ...
         switch(true)
         {
            ...
            case msg is EmoteAddMessage:
               ...
               if(!StoreDataManager.getInstance().getData(Constants.DATASTORE_COMPUTER_OPTIONS,"learnEmote" + eamsg.emoteId))
               {
                  ...
                  eamsgNid = uint(NotificationManager.getInstance().prepareNotification(I18n.getUiText("ui.common.emotes"),I18n.getUiText("ui.common.emoteAdded",[em.name]),NotificationTypeEnum.TUTORIAL,"new_emote_" + eamsg.emoteId));
            ...
            case msg is EmoteRemoveMessage:
               ...
               for(ire = 0; ire < this._emotes.length; )
               {
               ...
               for(ire2 = 0; ire2 < this._emotesList.length; )
               {
            ...
            case msg is EmotePlayMessage:
               ...
               else
               {
                  ...
                  spellLevelId = uint(e.spellLevelId);
