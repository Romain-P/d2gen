package com.ankamagames.dofus.logic.game.common.misc
{
   ...
   public class Inventory
   {
      ...
      public function getItem(uid:int) : ItemWrapper
      {
         ...
         {
            return (this._itemsDict[uid] as ItemSet#461).item;
         }
         return null;
      }
      ...
      public function initializeFromObjectItems(items:Vector.<ObjectItem>) : void
      {
         ...
         for(i = 0; i < l; i++)
         {
            ...
            this._itemsDict[item.objectUID] = new ItemSet#461(iw);
            list.push(iw);
         }
      ...
      protected function addItemToViews(itemSet:ItemSet#461) : void
      {
         var view:* = null;
      ...
      protected function modifyItemFromViews(itemSet:ItemSet#461, oldItem:ItemWrapper) : void
      {
         var mask:int = 0;
         var view:* = null;
         var quantity:int = 0;
      ...
      protected function removeItemFromViews(itemSet:ItemSet#461) : void
      {
         var view:* = null;
         for each(view in this._views)
         {
...
class ItemSet#461
{
   ...
   function ItemSet#461(iw:ItemWrapper)
   {
      super();
      this.item = iw;
   }
