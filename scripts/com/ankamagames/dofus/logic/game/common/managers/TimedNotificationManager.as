package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class TimedNotificationManager
   {
      ...
      private function onMatchTimerComplete(pEvent:TimerEvent) : void
      {
         ...
         {
            notificationId = uint(NotificationManager.getInstance().prepareNotification(I18n.getUiText("ui.esportTournament.tournament"),I18n.getUiText("ui.esportTournament.notificationText",[leagueName,notifMatch.teamOne.websiteUrl,notifMatch.teamOne.name,notifMatch.teamTwo.websiteUrl,notifMatch.teamTwo.name]),NotificationTypeEnum.SURVEY_INVITATION,"tournamentNotif"));
