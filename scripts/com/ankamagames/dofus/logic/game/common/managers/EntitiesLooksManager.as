package com.ankamagames.dofus.logic.game.common.managers
{
   ...
   public class EntitiesLooksManager
   {
      ...
      public function getLookFromContextInfos(pInfos:GameContextActorInformations, pForceCreature:Boolean = false) : TiphonEntityLook
      {
         ...
         else if(pInfos is GameFightCharacterInformations && !(this._entitiesFrame as FightEntitiesFrame).charactersMountsVisible)
         {
            ...
            if(oldBone == 2)
            {
               ...
               if(buffs && buffs.length > 0)
               {
                  ...
                  {
                     if(buff.actionId == ActionIdEnum.ACTION_CHARACTER_ADD_APPEARANCE)
                     {
