package com.ankamagames.dofus.logic.game.approach.frames
{
   ...
   public class GameServerApproachFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var crsa:* = null;
         var remodel:* = null;
         var tempColorsArray:* = null;
         var characterToConnect:* = null;
         ...
         var crwrrmsg:* = null;
         var cswrmsg:* = null;
         var charToRemodel:* = null;
         var indexedColors:* = null;
         var char:* = null;
         var modificationModules:* = null;
         var mandatoryModules:* = null;
         ...
         var j:int = 0;
         var bchar:* = null;
         var flashKeyMsg:* = null;
         var fpsManagerState:* = 0;
         var i:int = 0;
         var luaPlayer:* = null;
         var tag:* = null;
         var gift:* = null;
         ...
         switch(true)
         {
            ...
            case msg is AccountCapabilitiesMessage:
               ...
               if(PlayerManager.getInstance().restatEndDate != accmsg.unlimitedRestatEndDate)
               {
                  PlayerManager.getInstance().restatEndDate = accmsg.unlimitedRestatEndDate;
                  KernelEventsManager.getInstance().processCallback(HookList.RestatEndDateUpdate);
               }
            ...
            case msg is CharacterSelectedSuccessMessage:
               ...
               Dofus.getInstance().renameApp(cssmsg.infos.name + " - Dofus " + BuildInfos.VERSION.toString());
               ...
               if(cssmsg.isCollectingStats)
               {
                  ...
                  StatisticsManager.getInstance().initApiKey();
               }
               else
               {
               ...
               {
                  for(j = 0; j < this._charactersList.length; )
                  {
            ...
            case msg is AllModulesLoadedMessage:
               ...
               if(XmlConfig.getInstance().getBooleanEntry("config.dev.mode"))
               {
                  ...
                  if(XmlConfig.getInstance().getBooleanEntry("config.dev.auto.display.fpsManager"))
                  {
                     ...
                     fpsManagerState = uint(XmlConfig.getInstance().getEntry("config.dev.auto.display.fpsManager.state"));
                     if(fpsManagerState)
                     {
               ...
               {
                  if(OptionManager.getOptionManager("dofus")["optimizeMultiAccount"])
                  {
      ...
      {
         var updateInformationDisplayed:* = null;
