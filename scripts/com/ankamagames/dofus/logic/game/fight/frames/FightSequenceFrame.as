package com.ankamagames.dofus.logic.game.fight.frames
{
   ...
   public class FightSequenceFrame implements Frame, ISpellCastProvider
   {
      ...
      private function executeBuffer(callback:Function) : void
      {
         ...
         var entityAttaqueAnimWait:* = null;
         var lifeLoseSum:* = null;
         var lifeLoseLastStep:* = null;
         var shieldLoseSum:* = null;
         var shieldLoseLastStep:* = null;
      ...
      private function pushShieldPointsVariationStep(fighterId:Number, delta:int, actionId:int) : void
      {
      ...
      private function pushPointsLossDodgeStep(fighterId:Number, actionId:uint, amount:int) : void
      {
         ...
         switch(actionId)
         {
            case ActionIdEnum.ACTION_FIGHT_SPELL_DODGED_PA:
               step = new FightActionPointsLossDodgeStep(fighterId,amount);
               break;
            case ActionIdEnum.ACTION_FIGHT_SPELL_DODGED_PM:
      ...
      private function pushLifePointsVariationStep(fighterId:Number, delta:int, permanentDamages:int, action:int) : void
      {
