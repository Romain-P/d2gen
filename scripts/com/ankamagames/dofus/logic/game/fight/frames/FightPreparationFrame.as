package com.ankamagames.dofus.logic.game.fight.frames
{
   ...
   public class FightPreparationFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var swapPositionRequest:* = null;
         var gflmsg:* = null;
         var fighterSwapPositionRequests:* = null;
         var gfpppmsg:* = null;
         var ccmsg:* = null;
         var cellEntity:* = null;
         var gfppra:* = null;
         var iedi:* = null;
         var entitySwapPositionsRequests:* = null;
         var gfpspra:* = null;
         var gfpsprmsg:* = null;
         var gfpspomsg:* = null;
         var gfpspemsg:* = null;
         ...
         var ifpum:* = null;
         var gfemsg:* = null;
         var fightContextFrame2:* = null;
         var entity:* = null;
         var modContextMenu:* = null;
         var menu:* = null;
         var fighter:* = null;
         var fighterInfos:* = null;
         var gfpprmsg:* = null;
         var gfpprmsg2:* = null;
         var requesterInfos:* = null;
         var requestText:* = null;
         var cancellerInfo:* = null;
         var cancellerName:* = null;
         var teamMember:* = null;
         switch(true)
         {
            ...
            case msg is CellClickMessage:
               ...
               if(cellEntity)
               {
                  ...
                  else if(fighterInfos.contextualId != playerInfos.contextualId && fighterInfos.teamId == playerInfos.teamId)
                  {
            ...
            case msg is GameFightPlacementSwapPositionsErrorMessage:
               gfpspemsg = msg as GameFightPlacementSwapPositionsErrorMessage;
