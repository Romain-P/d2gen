package com.ankamagames.dofus.logic.game.fight.frames
{
   ...
   public class FightEntitiesFrame extends AbstractEntitiesFrame implements Frame
   {
      ...
      override public function process(msg:Message) : Boolean
      {
         ...
         var gfhrsmsg:* = null;
         var fighterInfoToBeReady:* = null;
         var ac2:* = null;
         var fightPreparationFrame:* = null;
         var gedmsg:* = null;
         var gfpspmsg:* = null;
         var iedi:* = null;
         var gedsmsg:* = null;
         ...
         var psum:* = null;
         var smifa:* = null;
         var staticRandomAnimModifier:* = null;
         var swords:* = null;
         ...
         switch(true)
         {
            ...
            case msg is GameFightHumanReadyStateMessage:
               ...
               if(fighterInfoToBeReady.disposition.cellId == -1)
               {
                  return true;
               }
            ...
            case msg is ShowMountsInFightAction:
               ...
               OptionManager.getOptionManager("dofus")["showMountsInFight"] = smifa.visibility;
               return true;
            default:
               return false;
         }
      ...
      public function switchMountsVisibility(pMountsVisibility:Boolean) : void
      {
         ...
         if(fscf && fscf.spellId == DataEnum.SPELL_SRAM_DOUBLE && fscf.hasInvocationPreview)
         {
      ...
      public function stopAllAnimations() : void
      {
         ...
         for each(entityInfos in _entities)
         {
            actor = DofusEntities.getEntity(entityInfos.contextualId);
            if(actor && actor is IAnimated && actor is TiphonSprite && (actor as TiphonSprite).isPlayingAnimation())
            {
               _log.debug("animation pour " + entityInfos.contextualId);
               (actor as TiphonSprite).stopAnimationAtEnd();
            }
         }
      }
      ...
      private function findTiphonSprite(doc:DisplayObjectContainer) : TiphonSprite
      {
         ...
         for(var i:int = 0; i < doc.numChildren; )
         {
      ...
      public function getOrdonnedPreFighters() : Vector.<Number>
      {
         ...
         var hiddenGuys:Array = new Array();
         for each(id in entitiesIds)
         {
            ...
            if(entityInfo)
            {
               ...
               {
                  stats = entityInfo.stats as GameFightMinimalStatsPreparation;
                  monsterGenericId = 0;
      ...
      public function updateFighter(fighterInfos:GameFightFighterInformations, animationModifier:IAnimationModifier = null) : void
      {
         ...
         if(fighterInfos.alive)
         {
            ...
            this.addCircleToFighter(ac,fighterInfos.teamId == TeamEnum.TEAM_DEFENDER?uint(TEAM_CIRCLE_COLOR_1):uint(TEAM_CIRCLE_COLOR_2));
         }
         else
         {
      ...
      private function updateCarriedEntities(fighterInfos:GameContextActorInformations) : void
      {
         ...
         var fedi:* = null;
         var carryingEntity:* = null;
         var carriedEntity:* = null;
