package com.ankamagames.dofus.logic.game.fight.frames
{
   ...
   public class FightBattleFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var gfnrmsg:* = null;
         var gflmsg:* = null;
         var fighterInfos2:* = null;
         var leaveSequenceFrame:* = null;
         var gfemsg:* = null;
         var maxEndRescue:int = 0;
         var gfpmsg:* = null;
         var rcmsg2:* = null;
         var infos:* = null;
         var fighter:* = null;
         ...
         var time:int = 0;
         var action:* = null;
         var fightEntitesFrame:* = null;
         var alivePlayers:int = 0;
         var en:* = null;
         var mouseOverEntityInfos:* = null;
         var mouseOverEntity:Boolean = false;
         var mouseOverTimelineEntity:Boolean = false;
         var fighterInfosTE:* = null;
         var fakeDeathMessage:* = null;
         var seqEnd:* = null;
         var fakegfemsg:* = null;
         switch(true)
         {
            ...
            case msg is GameFightTurnStartMessage:
               ...
               KernelEventsManager.getInstance().processCallback(HookList.GameFightTurnStart,gftsmsg.id,gftsmsg.waitTime * 100,!!isResumeMessage?(msg as GameFightTurnResumeMessage).remainingTime * 100:gftsmsg.waitTime * 100,Dofus.getInstance().options.turnPicture);
               ...
               if(gftsmsg.id == playerId || this._playingSlaveEntity)
               {
                  ...
                  {
                     time = getTimer();
                     if(AFKFightManager.getInstance().lastTurnSkip + 5000 < time)
                     {
                     ...
                     {
                        this._skipTurnTimer = new Timer(5000 - (time - AFKFightManager.getInstance().lastTurnSkip),1);
               ...
               numEntities = uint(entitiesIds.length);
            ...
            case msg is GameFightLeaveMessage:
               ...
               if(fighterInfos2 && fighterInfos2.alive)
               {
      ...
      public function getNextPlayableCharacterId() : Number
      {
         ...
         for(var i:int = 0; i < this._turnsList.length; )
         {
      ...
      private function confirmTurnEnd() : void
      {
         ...
         if(fighterInfos2)
         {
            ...
            char = CurrentPlayedFighterManager.getInstance().getCharacteristicsInformations(this._lastPlayerId);
            if(char)
            {
      ...
      private function gameFightSynchronize(fighters:Vector.<GameFightFighterInformations>, synchronizeBuff:Boolean = true) : void
      {
         ...
         var fighterInfos:* = null;
         var playedFighterCharacteristicsInformations:* = null;
         var sequencer:* = null;
