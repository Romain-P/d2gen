      ...
      override public function start() : void
      {
         ...
         if(carryingEntity is TiphonSprite)
         {
            ...
            if(targetPosition)
            {
               ...
               carriedEntityDirection = uint(position.advancedOrientationTo(targetPosition));
