package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightMarkCellsStep extends AbstractSequencable implements IFightStep
   {
      ...
      override public function start() : void
      {
         ...
         var originMarkSpellLevel:SpellLevel = spell.getSpellLevel(this._markSpellLevel.grade);
         ...
         MarkedCellsManager.getInstance().addMark(this._markId,this._markType,spell,this._markSpellLevel,this._cells,this._markTeamId,this._markActive,this._markImpactCell);
