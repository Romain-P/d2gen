package com.ankamagames.dofus.logic.game.fight.steps
{
   ...
   public class FightLossAnimStep extends AbstractSequencable implements IFightStep
   {
      ...
      {
         var ccm:CharacteristicContextual = CharacteristicContextualManager.getInstance().addStatContextual(this._value.toString(),this._target,new TextFormat("Verdana",24,this._color,true),OptionManager.getOptionManager("tiphon").pointsOverhead,GameContextEnum.FIGHT);
         executeCallbacks();
      }
