package com.ankamagames.dofus.logic.game.fight.miscs
{
   ...
   public class ActionIdEnum implements IDataCenter
   {
      ...
      public static const ACTION_CHARACTER_PLAY_SPELL_ANIMATION:int = 237;
      ...
      public static const ACTION_CHARACTER_REMOVE_ALL_SPELL_EFFECTS:int = 406;
      
      public static const ACTION_CHARACTER_BOOST_AP_ATTACK:int = 410;
      
      public static const ACTION_CHARACTER_BOOST_MP_ATTACK:int = 412;
      
      public static const ACTION_BOOST_PUSH_DMG:int = 414;
      
      public static const ACTION_DEBOOST_PUSH_DMG_REDUCTION:int = 417;
      ...
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_CASTER_LIFE_MIDLIFE:int = 672;
      
      public static const ACTION_CHARACTER_JOB_REFERENCEMENT:int = 699;
      ...
      public static const ACTION_USE_PRESET:int = 707;
      ...
      public static const ACTION_CHARACTER_CHATIMENT:int = 788;
      ...
      public static const ACTION_HUNT_TOOL:int = 795;
      ...
      public static const ACTION_ITEM_DUNGEON_KEY_DATE:int = 814;
      ...
      public static const ACTION_PET_POWER_BOOST:int = 940;
      ...
      public static const ACTION_SHOW_ALIGNMENT:int = 960;
      
      public static const ACTION_SHOW_GRADE:int = 961;
      
      public static const ACTION_SHOW_LEVEL:int = 962;
      
      public static const ACTION_CREATED_SINCE:int = 963;
      
      public static const ACTION_SHOW_PLAYERNAME:int = 964;
      
      public static const ACTION_LIVING_OBJECT_ID:int = 970;
      
      public static const ACTION_LIVING_OBJECT_MOOD:int = 971;
      
      public static const ACTION_LIVING_OBJECT_SKIN:int = 972;
      
      public static const ACTION_LIVING_OBJECT_CATEGORY:int = 973;
      
      public static const ACTION_LIVING_OBJECT_LEVEL:int = 974;
      
      public static const ACTION_LINKED_TO_CHARACTER:int = 981;
      
      public static const ACTION_LINKED_TO_ACCOUNT:int = 982;
      
      public static const ACTION_LINKED_UNTIL_DATE:int = 983;
      
      public static const ACTION_NAME_MAGE:int = 985;
      
      public static const ACTION_NAME_OWNER:int = 987;
      
      public static const ACTION_NAME_CRAFTER:int = 988;
      
      public static const ACTION_MOUNT_DESCRIPTION:int = 995;
      
      public static const ACTION_MOUNT_DESCRIPTION_OWNER:int = 996;
      
      public static const ACTION_MOUNT_DESCRIPTION_WITH_DATE:int = 998;
      
      public static const ACTION_PET_REDUCE_MAX_BONUS:int = 1005;
      
      public static const ACTION_PET_REDUCE_MIN_BONUS:int = 1006;
      
      public static const ACTION_SUMMON_BOMB:int = 1008;
      
      public static const ACTION_SUMMON_SLAVE:int = 1011;
      
      public static const ACTION_TARGET_EXECUTE_SPELL_ON_SOURCE:int = 1017;
      
      public static const ACTION_SOURCE_EXECUTE_SPELL_ON_TARGET:int = 1018;
      
      public static const ACTION_SOURCE_EXECUTE_SPELL_ON_SOURCE:int = 1019;
      
      public static const ACTION_CHARACTER_ADD_RANDOM_ILLUSION:int = 1024;
      ...
      public static const ACTION_CHARACTER_GET_PUSHED:int = 1041;
      
      public static const ACTION_CHARACTER_GET_PULLED:int = 1042;
      
      public static const ACTION_CHARACTER_IMMUNITY_AGAINST_SPELL:int = 1044;
      
      public static const ACTION_CHARACTER_SET_SPELL_COOLDOWN:int = 1045;
      ...
      public static const ACTION_CHARACTER_GAIN_JOB_LEVEL:int = 1050;
      
      public static const ACTION_BOOST_SPELL_DAMAGES_PERCENT:int = 1054;
      
      public static const ACTION_SHARE_DAMAGES:int = 1061;
      
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_TARGET_LIFE_FROM_WATER:int = 1068;
      
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_TARGET_LIFE_FROM_EARTH:int = 1070;
      
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_TARGET_LIFE_FROM_AIR:int = 1067;
      
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_TARGET_LIFE_FROM_FIRE:int = 1069;
      
      public static const ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_TARGET_LIFE:int = 1071;
      
      public static const ACTION_CHARACTER_SHORTEN_ACTIVE_EFFECTS_DURATION:int = 1075;
      ...
      public static const ACTION_BOOST_ITEM_WEIGHT:int = 1081;
      
      public static const ACTION_ITEM_GIFT_CONTENT:int = 1084;
      
      public static const ACTION_PLACE_GLYPH_AURA:int = 1091;
      
      public static const ACTION_CHARACTER_ADD_MIRROR_ILLUSION:int = 1097;
      
      public static const ACTION_TELEPORT_TO_TURN_START_POSITION:int = 1099;
      
      public static const ACTION_TELEPORT_TO_PREVIOUS_POSITION:int = 1100;
      
      public static const ACTION_SPEAKING_OBJECT:int = 1102;
      
      public static const ACTION_TELEPORT_MIRROR_BY_TARGET:int = 1104;
      
      public static const ACTION_TELEPORT_MIRROR_BY_CASTER:int = 1105;
      
      public static const ACTION_TELEPORT_MIRROR_BY_AREA_CENTER:int = 1106;
      
      public static const ACTION_GAIN_LIFE_ON_TARGET_LIFE_PERCENT:int = 1109;
      
      public static const ACTION_ITEM_LOOT_COUNT:int = 1111;
      
      public static const ACTION_FIGHT_BOOST_WEAPON_DAMAGE_POWER:int = 1144;
      
      public static const ACTION_ITEM_SKIN_ITEM:int = 1151;
      
      public static const ACTION_CHARACTER_MULTIPLY_RECEIVED_HEAL:int = 1159;
      
      public static const ACTION_CASTER_EXECUTE_SPELL:int = 1160;
      
      public static const ACTION_CHARACTER_COMPANION:int = 1161;
      
      public static const ACTION_CHARACTER_MULTIPLY_RECEIVED_DAMAGE:int = 1163;
      
      public static const ACTION_CHARACTER_GIVE_LIFE_WITH_RATIO:int = 1164;
      
      public static const ACTION_BOOST_FINAL_DAMAGES_PERCENT:int = 1171;
      
      public static const ACTION_DEBOOST_FINAL_DAMAGES_PERCENT:int = 1172;
      
      public static const ACTION_CAST_SPELL_AT_FIGHT_START:int = 1175;
      
      public static const ACTION_WRAPPER_OBJECT_GID:int = 1176;
      
      public static const ACTION_WRAPPER_OBJECT_CATEGORY:int = 1179;
      
      public static const ACTION_FIGHT_DISABLE_PORTAL:int = 1183;
      
      public static const ACTION_MOUNT_HARNESS_GID:int = 1187;
      
      public static const ACTION_MOUNT_ADD_CAPACITY:int = 1188;
      
      public static const ACTION_ITEM_NUGGETS_SHARING:int = 2021;
      
      public static const ACTION_LAUNCH_FINISH_MOVE:int = 2029;
      
      public static const ACTION_TARGET_CAST_SPELL_ON_TARGETED_CELL:int = 2794;
      
      public static const ACTION_KILL_AND_SUMMON_SLAVE:int = 2796;
      
      public static const ACTION_CHARACTER_BOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_MELEE:int = 2800;
      
      public static const ACTION_CHARACTER_DEBOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_MELEE:int = 2801;
      
      public static const ACTION_CHARACTER_BOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_MELEE:int = 2802;
      
      public static const ACTION_CHARACTER_DEBOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_MELEE:int = 2803;
      
      public static const ACTION_CHARACTER_BOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_DISTANCE:int = 2804;
      
      public static const ACTION_CHARACTER_DEBOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_DISTANCE:int = 2805;
      
      public static const ACTION_CHARACTER_BOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_DISTANCE:int = 2806;
      
      public static const ACTION_CHARACTER_DEBOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_DISTANCE:int = 2807;
      
      public static const ACTION_CHARACTER_BOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_WEAPON:int = 2808;
      
      public static const ACTION_CHARACTER_DEBOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_WEAPON:int = 2809;
      
      public static const ACTION_CHARACTER_BOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_WEAPON:int = 2810;
      
      public static const ACTION_CHARACTER_DEBOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_WEAPON:int = 2811;
      
      public static const ACTION_CHARACTER_BOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_SPELLS:int = 2812;
      
      public static const ACTION_CHARACTER_DEBOOST_DEALT_DAMAGE_PERCENT_MULTIPLIER_SPELLS:int = 2813;
      
      public static const ACTION_CHARACTER_BOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_SPELLS:int = 2814;
      
      public static const ACTION_CHARACTER_DEBOOST_RECEIVED_DAMAGE_PERCENT_MULTIPLIER_SPELLS:int = 2815;
      
      public static const ACTION_EVOLVING_IMPROVEMENT_POINTS:int = 2818;
      
      public static const ACTION_EVOLVING_EXPERIENCE_POINTS:int = 2819;
      
      public static const ACTION_ITEM_GIVEN_EXPERIENCE_AS_SUPERFOOD:int = 2820;
      
      public static const ACTION_EVOLVING_LEVEL:int = 2821;
      ...
      public static function initialize() : void
      {
         if(!_initialized)
         {
            ...
            _actionInfos[ACTION_CHARACTER_BOOST_AP_ATTACK] = ["PAAttack",true];
            _actionInfos[ACTION_CHARACTER_BOOST_MP_ATTACK] = ["PMAttack",true];
            _actionInfos[ACTION_BOOST_PUSH_DMG] = ["pushDamageBonus",true];
            _actionInfos[ACTION_DEBOOST_PUSH_DMG_REDUCTION] = ["pushDamageFixedResist",false];
            _actionInfos[ACTION_CHARACTER_MAKE_INVISIBLE] = ["invisibilityState",true];
            _actionInfos[ACTION_FIGHT_BOOST_WEAPON_DAMAGE_POWER] = ["weaponDamagesBonusPercent",true];
            _initialized = true;
         }
      }
