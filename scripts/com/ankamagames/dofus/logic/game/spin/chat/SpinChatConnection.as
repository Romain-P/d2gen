package com.ankamagames.dofus.logic.game.spin.chat
{
   ...
   public class SpinChatConnection extends SpinConnection
   {
      ...
      override protected function onMessage(msg:Message) : void
      {
         ...
         var endpointOccupations:* = null;
         var endpointOccupation:* = null;
         var friendAliasSet:* = null;
         var ignoreSet:* = null;
         var friendRemoved:* = null;
         var friendGroupSet:* = null;
         var friendGroupSetFriend:* = null;
         var groupAdded:* = null;
         var groupDeleted:* = null;
         var inviteSent:* = null;
         var inviteAccepted:* = null;
         var newFriend:* = null;
         var inviteRejected:* = null;
         var rejectedUser:* = null;
         var inviteCancelled:* = null;
