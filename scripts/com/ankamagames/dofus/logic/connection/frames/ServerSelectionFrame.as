package com.ankamagames.dofus.logic.connection.frames
{
   ...
   public class ServerSelectionFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var asmsg:* = null;
         var asemsg:* = null;
         var reasonSearchError:* = null;
         var aslmsg:* = null;
         var ssrmsg:* = null;
         var error:* = null;
         var mslm:* = null;
         var knownServer:* = null;
         var serverAlreadyInName:* = null;
         var serverSelectedName:* = null;
         var commonMod:* = null;
         ...
         switch(true)
         {
            ...
            case msg is ServerConnectionFailedMessage:
               ...
               formerPort = uint(scfm.failedConnection.port);
               ...
               if(this._connexionPorts && this._connexionPorts.length)
               {
                  ...
                  {
                     newPort = uint(this._connexionPorts[0]);
