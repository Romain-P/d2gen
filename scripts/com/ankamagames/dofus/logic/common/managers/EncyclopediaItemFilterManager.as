      ...
      override public function dataInit(specificFilters:Array = null) : void
      {
         ...
         switch(_currentCategory)
         {
            case EQUIPMENT_CATEGORY:
               ...
               {
                  setSubFilters(DataEnum.ITEM_SUPERTYPE_DOFUS_TROPHY,DataEnum.ITEM_SUPERTYPE_DOFUS_TROPHY,_currentUi.uiClass.uiApi.getText("ui.encyclopedia.dofusCategory"));
               }
               this.addObtainingMethodCategory(_currentUi.uiClass.uiApi.getText("ui.encyclopedia.obtainingTitle"),"obtaining");
               break;
            ...
            case SKIN_CATEGORY:
               ...
               {
                  setSubFilters(DataEnum.ITEM_SUPERTYPE_LIVING_ITEMS,DataEnum.ITEM_SUPERTYPE_LIVING_ITEMS,_currentUi.uiClass.uiApi.getText("ui.common.category"));
               }
