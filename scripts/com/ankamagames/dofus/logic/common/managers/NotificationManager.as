package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class NotificationManager
   {
      ...
      private var _notificationList:Vector.<Notification#243>;
      
      public function NotificationManager(pvt:PrivateClass#243)
      {
         super();
         this._notificationList = new Vector.<Notification#243>();
      }
      ...
      public static function getInstance() : NotificationManager
      {
         if(_self == null)
         {
            _self = new NotificationManager(new PrivateClass#243());
         }
         return _self;
      }
      ...
      {
         var notif:Notification = new Notification#243();
         notif.title = pTitle;
      ...
      public function addButtonToNotification(pId:uint, pTitle:String, pAction:String, pParams:Object = null, pForceClose:Boolean = false, pWidth:Number = 0, pHeight:Number = 0, pType:String = "action", pIcnDataId:String = null, pIcnSize:uint = 0) : void
      {
      ...
      public function sendNotification(notificationId:int = -1) : void
      {
         ...
         {
            this.openNotification(this._notificationList[notificationId] as Notification#243);
      ...
      private function getNotification(pId:uint) : Notification#243
      {
...
class PrivateClass#243
{
    
   
   function PrivateClass#243()
   {
      super();
   }
}
...
class Notification#243
{
   ...
   public function addButton(pTitle:String, pAction:String, pParams:Object = null, pForceClose:Boolean = false, pWidth:Number = 0, pHeight:Number = 0, pType:String = "action", pIcnDataId:String = null, pIcnSize:uint = 0) : void
   {
