         ...
         switch(true)
         {
            case msg is DirectSelectionCharacterAction:
               ...
               else
               {
                  ...
                  else if(SteamManager.hasSteamApi() && SteamManager.getInstance().isSteamEmbed() || UpdaterApi.canLoginWithZaap())
                  {
                     if(UpdaterApi.canLoginWithZaap() && !UpdaterApi.isUsingZaap())
                     {
                        forceNoRetry = true;
                     }
                     else
            ...
            case msg is AccountInformationsUpdateMessage:
               ...
               if(PlayerManager.getInstance().restatEndDate != aiumsg.unlimitedRestatEndDate)
               {
                  PlayerManager.getInstance().restatEndDate = aiumsg.unlimitedRestatEndDate;
