package com.ankamagames.dofus.logic.common.frames
{
   ...
   public class FightBotFrame implements Frame
   {
      ...
      {
         var startFightMsg:* = null;
         var turnStartMsg:* = null;
         switch(true)
         {
      ...
      private function fakeActivity() : void
      {
         ...
         setTimeout(this.fakeActivity,300000);
      ...
      {
         var cellId:* = 0;
         var avaibleCells:* = null;
         var entity:* = undefined;
         var monster:* = null;
         var gafcrmsg:GameActionFightCastRequestMessage = new GameActionFightCastRequestMessage();
         if(onMySelf)
         {
            cellId = uint(FightEntitiesFrame.getCurrentInstance().getEntityInfos(PlayedCharacterManager.getInstance().id).disposition.cellId);
         }
         else
         {
            avaibleCells = [];
