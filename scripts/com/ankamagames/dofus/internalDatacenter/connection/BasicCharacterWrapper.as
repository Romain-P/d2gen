package com.ankamagames.dofus.internalDatacenter.connection
{
   ...
   public class BasicCharacterWrapper implements IDataCenter
   {
      ...
      public static function create(id:Number, name:String, level:uint, entityLook:EntityLook, breed:uint, sex:Boolean, deathState:uint = 0, deathCount:uint = 0, bonusXp:uint = 0, unusable:Boolean = false) : BasicCharacterWrapper
      {
