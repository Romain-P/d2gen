package com.ankamagames.dofus.internalDatacenter.communication
{
   ...
   public class ChatSentenceWithSource extends BasicChatSentence implements IDataCenter
   {
      ...
      public function ChatSentenceWithSource(id:uint, baseMsg:String, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, senderName:String = "", objects:Vector.<ItemWrapper> = null, admin:Boolean = false)
      {
