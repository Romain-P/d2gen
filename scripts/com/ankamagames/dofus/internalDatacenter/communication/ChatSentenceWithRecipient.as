package com.ankamagames.dofus.internalDatacenter.communication
{
   ...
   public class ChatSentenceWithRecipient extends ChatSentenceWithSource implements IDataCenter
   {
      ...
      public function ChatSentenceWithRecipient(id:uint, baseMsg:String, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, senderName:String = "", receiverName:String = "", receiverId:Number = 0, objects:Vector.<ItemWrapper> = null)
      {
