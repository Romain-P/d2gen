package com.ankamagames.dofus.internalDatacenter.items
{
   ...
   public class ShortcutWrapper extends Proxy implements ISlotData, IDataCenter
   {
      ...
      public static function create(slot:uint, id:uint, type:uint = 0, gid:uint = 0) : ShortcutWrapper
      {
         ...
         var emoteWrapper:* = null;
         var rpEmoteFrame:* = null;
         var smiley:* = null;
         var smileyWrapper:* = null;
         ...
         {
            smiley = Smiley#98.getSmileyById(id);
            if(smiley)
            {
      ...
      {
         var itemWrapper:* = null;
         var fakeItemWrapper:* = null;
         var builds:* = null;
         var buildWrapper:* = null;
         var spellWrapper:* = null;
         var smileyWrapper:* = null;
         var emoteWrapper:* = null;
         var idolsPresets:* = null;
         var idolsPreset:* = null;
