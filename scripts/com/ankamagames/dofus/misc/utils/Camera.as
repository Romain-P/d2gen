   ...
   public class Camera
   {
      ...
      public function zoomOnPos(pTargetZoom:Number, pTargetX:Number, pTargetY:Number) : void
      {
         ...
         else
         {
            ...
            finalX = Number(-pTargetX * pTargetZoom + CENTER_X);
            finalY = Number(-pTargetY * pTargetZoom + CENTER_Y);
            if((LASTCELL_X - pTargetX) * pTargetZoom < LASTCELL_X / 2)
            {
               finalX = Number(finalX + (CENTER_X - (1280 - pTargetX) * pTargetZoom));
            ...
            {
               finalY = Number(finalY + (CENTER_Y - (874 - pTargetY) * pTargetZoom));
