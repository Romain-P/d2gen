      ...
      private function onNewData(e:MapEditorDataEvent) : void
      {
         ...
         switch(e.data.type)
         {
            ...
            case MapEditorMessage.MESSAGE_TYPE_NPC:
               ...
               npcCount = uint(e.data.data.readInt());
               ...
               mciMsg.initMapComplementaryInformationsDataMessage(!!subArea?uint(subArea.id):0,mapId,new Vector.<HouseInformations>(),npcInfos,new Vector.<InteractiveElement>(),new Vector.<StatedElement>(),new Vector.<MapObstacle>(),new Vector.<FightCommonInformations>());
