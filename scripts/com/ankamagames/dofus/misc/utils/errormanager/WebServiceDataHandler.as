package com.ankamagames.dofus.misc.utils.errormanager
{
   ...
   public class WebServiceDataHandler extends EventDispatcher
   {
      ...
      private static const MAX_DELAY:int = 300 - MIN_DELAY;
      ...
      public function WebServiceDataHandler(pPrivate:PrivateClass#56)
      {
      ...
      public static function getInstance() : WebServiceDataHandler
      {
         if(_self == null)
         {
            _self = new WebServiceDataHandler(new PrivateClass#56());
         }
         return _self;
      }
