package com.ankamagames.dofus.misc.utils
{
   ...
   public class SurveyManager
   {
      ...
      public function markSurveyAsDone(surveyId:Number, accepted:Boolean) : void
      {
         ...
         {
            totalClosedSurveys = uint(StoreDataManager.getInstance().getSetData(this._dataStore,"totalClosedSurveys",0));
      ...
      private function getSurveysFromHaapi() : void
      {
         HaapiKeyManager.getInstance().addEventListener(ApiKeyReadyEvent.READY,function(e:ApiKeyReadyEvent):void
         {
            ...
            _surveyApi.getApiClient().setApiKey(e.haapiKey);
