package com.ankamagames.dofus.misc.utils
{
   ...
   public class SubhintInspector
   {
      ...
      private var _lastTarget:Vector.<InteractiveItem#183>;
      
      private var _underPoint:Point;
      
      private var _currentShortCut:ShortcutItem#183;
      ...
      private function onRollout(e:*) : void
      {
         ...
         for(this._currentShortCut = null; this._tooltip.numChildren > 0; )
         {
      ...
      {
         var textFieldSize:* = null;
         var tooltipTf:* = null;
         var tooltipStr:* = null;
         var item:* = null;
         var currentTooltipStr:* = null;
         var tooltipItemTf:* = null;
         var tfItem:* = null;
         ...
         var ind:* = "";
         for(var i:int = 0; i < this._lastTarget.length; i++)
         {
         ...
         {
            this._currentShortCut = new ShortcutItem#183("Freeze",Keyboard.S,this.freeze,true);
         }
      ...
      private function findElements(target:DisplayObject) : Vector.<InteractiveItem#183>
      {
         var currentItem:* = null;
         var result:Vector.<InteractiveItem> = new Vector.<SubhintInspector>();
         var ind:String = "";
      ...
      private function cast(target:DisplayObject) : InteractiveItem#183
      {
         var currentItem:* = null;
         switch(true)
         {
            ...
            case target is GraphicContainer:
               currentItem = new InteractiveItemUi#183();
...
class ShortcutItem#183
{
   ...
   function ShortcutItem#183(legend:String, key:uint, callback:Function, shift:Boolean)
   {
      super();
      this.legend = legend;
      this.key = key;
...
class InteractiveItem#183
{
   ...
   public var shortcut:ShortcutItem#183;
...
class InteractiveItemUi#183 extends InteractiveItem#183
{
    
   
   function InteractiveItemUi#183()
   {
      super();
   }
