package com.ankamagames.dofus.misc.stats.ui
{
   ...
   public class NicknameRegistrationStats implements IUiStats, IHookStats
   {
      ...
      {
         var screenQuality:* = null;
         super();
         this._action = StatsAction.get(EVENT_ID,false,false,true);
         switch(OptionManager.getOptionManager("dofus")["dofusQuality"])
         {
            case 0:
               screenQuality = "LOW";
               break;
         ...
         this._action.setParam("screen_size",OptionManager.getOptionManager("dofus")["smallScreenFont"] == false?17:15);
