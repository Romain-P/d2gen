package com.ankamagames.dofus.misc.lists
{
   ...
   public class FightHookList
   {
      ...
      public static const UpdateFightersLook:Hook = new Hook("UpdateFightersLook",false);
      ...
      public static const ArenaFighterLeave:Hook = new Hook("ArenaFighterLeave",false);
      
      public static const OpenFightResults:Hook = new Hook("OpenFightResults",false);
