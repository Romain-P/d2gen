package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightTeamLightInformations extends AbstractFightTeamInformations implements INetworkType
   {
      ...
      public function serializeAs_FightTeamLightInformations(output:ICustomDataOutput) : void
      {
         ...
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.hasFriend));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.hasGuildMember));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.hasAllianceMember));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.hasGroupMember));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,4,this.hasMyTaxCollector));
