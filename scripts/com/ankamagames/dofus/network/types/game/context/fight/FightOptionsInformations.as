package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightOptionsInformations implements INetworkType
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.isSecret));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.isRestrictedToPartyOnly));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.isClosed));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.isAskingForHelp));
