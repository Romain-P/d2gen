package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayMerchantInformations extends GameRolePlayNamedActorInformations implements INetworkType
   {
      ...
      public function initGameRolePlayMerchantInformations(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, name:String = "", sellType:uint = 0, options:Vector.<HumanOption> = null) : GameRolePlayMerchantInformations
      {
      ...
      public function serializeAs_GameRolePlayMerchantInformations(output:ICustomDataOutput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < this.options.length; _i2++)
         {
      ...
      public function deserializeAs_GameRolePlayMerchantInformations(input:ICustomDataInput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < _optionsLen; _i2++)
         {
