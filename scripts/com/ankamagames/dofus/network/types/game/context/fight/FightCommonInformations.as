package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightCommonInformations implements INetworkType
   {
      ...
      public function serializeAs_FightCommonInformations(output:ICustomDataOutput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < this.fightTeams.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.fightTeamsPositions.length; _i4++)
         {
         ...
         for(var _i5:int = 0; _i5 < this.fightTeamsOptions.length; _i5++)
         {
      ...
      public function deserializeAs_FightCommonInformations(input:ICustomDataInput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < _fightTeamsLen; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < _fightTeamsPositionsLen; _i4++)
         {
         ...
         for(var _i5:int = 0; _i5 < _fightTeamsOptionsLen; _i5++)
         {
