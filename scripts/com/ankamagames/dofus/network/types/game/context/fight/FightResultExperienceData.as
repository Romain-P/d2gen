package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightResultExperienceData extends FightResultAdditionalData implements INetworkType
   {
      ...
      public function serializeAs_FightResultExperienceData(output:ICustomDataOutput) : void
      {
         ...
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.showExperience));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.showExperienceLevelFloor));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.showExperienceNextLevelFloor));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.showExperienceFightDelta));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,4,this.showExperienceForGuild));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,5,this.showExperienceForMount));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,6,this.isIncarnationExperience));
