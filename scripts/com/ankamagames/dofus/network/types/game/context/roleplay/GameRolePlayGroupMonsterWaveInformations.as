package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayGroupMonsterWaveInformations extends GameRolePlayGroupMonsterInformations implements INetworkType
   {
      ...
      public function initGameRolePlayGroupMonsterWaveInformations(contextualId:Number = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, staticInfos:GroupMonsterStaticInformations = null, creationTime:Number = 0, ageBonusRate:uint = 0, lootShare:int = 0, alignmentSide:int = 0, keyRingBonus:Boolean = false, hasHardcoreDrop:Boolean = false, hasAVARewardToken:Boolean = false, nbWaves:uint = 0, alternatives:Vector.<GroupMonsterStaticInformations> = null) : GameRolePlayGroupMonsterWaveInformations
      {
         super.initGameRolePlayGroupMonsterInformations(contextualId,look,disposition,staticInfos,creationTime,ageBonusRate,lootShare,alignmentSide,keyRingBonus,hasHardcoreDrop,hasAVARewardToken);
      ...
      public function serializeAs_GameRolePlayGroupMonsterWaveInformations(output:ICustomDataOutput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < this.alternatives.length; _i2++)
         {
      ...
      public function deserializeAs_GameRolePlayGroupMonsterWaveInformations(input:ICustomDataInput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < _alternativesLen; _i2++)
         {
            _id2 = uint(input.readUnsignedShort());
