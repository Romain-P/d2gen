package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightStartingPositions implements INetworkType
   {
      ...
      public function serializeAs_FightStartingPositions(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.positionsForChallengers.length; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < this.positionsForDefenders.length; _i2++)
         {
      ...
      public function deserializeAs_FightStartingPositions(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _positionsForChallengersLen; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < _positionsForDefendersLen; _i2++)
         {
