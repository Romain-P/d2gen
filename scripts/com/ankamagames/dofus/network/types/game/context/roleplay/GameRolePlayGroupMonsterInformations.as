package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayGroupMonsterInformations extends GameRolePlayActorInformations implements INetworkType
   {
      ...
      public function serializeAs_GameRolePlayGroupMonsterInformations(output:ICustomDataOutput) : void
      {
         ...
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.keyRingBonus));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.hasHardcoreDrop));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.hasAVARewardToken));
