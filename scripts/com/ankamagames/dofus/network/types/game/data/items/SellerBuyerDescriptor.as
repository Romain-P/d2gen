package com.ankamagames.dofus.network.types.game.data.items
{
   ...
   public class SellerBuyerDescriptor implements INetworkType
   {
      ...
      public function serializeAs_SellerBuyerDescriptor(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.quantities.length; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < this.types.length; _i2++)
         {
            if(this.types[_i2] < 0)
            {
      ...
      public function deserializeAs_SellerBuyerDescriptor(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _quantitiesLen; _i1++)
         {
            _val1 = uint(input.readVarUhInt());
            if(_val1 < 0)
            {
         ...
         for(var _i2:int = 0; _i2 < _typesLen; _i2++)
         {
            _val2 = uint(input.readVarUhInt());
            if(_val2 < 0)
            {
