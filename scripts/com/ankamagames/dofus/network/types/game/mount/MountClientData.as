package com.ankamagames.dofus.network.types.game.mount
{
   ...
   public class MountClientData implements INetworkType
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.sex));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.isRideable));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.isWild));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.isFecondationReady));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,4,this.useHarnessColors));
         ...
         for(var _i3:int = 0; _i3 < this.ancestor.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.behaviors.length; _i4++)
         {
         ...
         for(var _i34:int = 0; _i34 < this.effectList.length; _i34++)
         {
      ...
      public function deserializeAs_MountClientData(input:ICustomDataInput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < _ancestorLen; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < _behaviorsLen; _i4++)
         {
         ...
         for(var _i34:int = 0; _i34 < _effectListLen; _i34++)
         {
