package com.ankamagames.dofus.network.types.game.achievement
{
   ...
   public class Achievement implements INetworkType
   {
      ...
      public function serializeAs_Achievement(output:ICustomDataOutput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < this.finishedObjective.length; _i2++)
         {
         ...
         for(var _i3:int = 0; _i3 < this.startedObjectives.length; _i3++)
         {
      ...
      public function deserializeAs_Achievement(input:ICustomDataInput) : void
      {
         ...
         for(var _i2:int = 0; _i2 < _finishedObjectiveLen; _i2++)
         {
         ...
         for(var _i3:int = 0; _i3 < _startedObjectivesLen; _i3++)
         {
