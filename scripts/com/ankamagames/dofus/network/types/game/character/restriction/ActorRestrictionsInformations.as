package com.ankamagames.dofus.network.types.game.character.restriction
{
   ...
   public class ActorRestrictionsInformations implements INetworkType
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.cantBeAggressed));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.cantBeChallenged));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.cantTrade));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.cantBeAttackedByMutant));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,4,this.cantRun));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,5,this.forceSlowWalk));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,6,this.cantMinimize));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,7,this.cantMove));
         output.writeByte(_box0);
         var _box1:* = 0;
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,0,this.cantAggress));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,1,this.cantChallenge));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,2,this.cantExchange));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,3,this.cantAttack));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,4,this.cantChat));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,5,this.cantBeMerchant));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,6,this.cantUseObject));
         _box1 = uint(BooleanByteWrapper.setFlag(_box1,7,this.cantUseTaxCollector));
         output.writeByte(_box1);
         var _box2:* = 0;
         _box2 = uint(BooleanByteWrapper.setFlag(_box2,0,this.cantUseInteractive));
         _box2 = uint(BooleanByteWrapper.setFlag(_box2,1,this.cantSpeakToNPC));
         _box2 = uint(BooleanByteWrapper.setFlag(_box2,2,this.cantChangeZone));
         _box2 = uint(BooleanByteWrapper.setFlag(_box2,3,this.cantAttackMonster));
         _box2 = uint(BooleanByteWrapper.setFlag(_box2,4,this.cantWalk8Directions));
