package com.ankamagames.dofus.network.types.game.house
{
   ...
   public class HouseInstanceInformations implements INetworkType
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.secondHand));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.isLocked));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.isSaleLocked));
