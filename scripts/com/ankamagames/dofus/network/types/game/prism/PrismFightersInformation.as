package com.ankamagames.dofus.network.types.game.prism
{
   ...
   public class PrismFightersInformation implements INetworkType
   {
      ...
      public function serializeAs_PrismFightersInformation(output:ICustomDataOutput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < this.allyCharactersInformations.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.enemyCharactersInformations.length; _i4++)
         {
      ...
      public function deserializeAs_PrismFightersInformation(input:ICustomDataInput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < _allyCharactersInformationsLen; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < _enemyCharactersInformationsLen; _i4++)
         {
