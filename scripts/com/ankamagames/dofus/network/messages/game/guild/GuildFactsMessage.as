package com.ankamagames.dofus.network.messages.game.guild
{
   ...
   public class GuildFactsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initGuildFactsMessage(infos:GuildFactSheetInformations = null, creationDate:uint = 0, nbTaxCollectors:uint = 0, members:Vector.<CharacterMinimalInformations> = null) : GuildFactsMessage
      {
         this.infos = infos;
      ...
      public function serializeAs_GuildFactsMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i4:int = 0; _i4 < this.members.length; _i4++)
         {
            (this.members[_i4] as CharacterMinimalInformations).serializeAs_CharacterMinimalInformations(output);
         }
      }
      ...
      public function deserializeAs_GuildFactsMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i4:int = 0; _i4 < _membersLen; _i4++)
         {
            _item4 = new CharacterMinimalInformations();
      ...
      {
         var _item:CharacterMinimalInformations = new CharacterMinimalInformations();
