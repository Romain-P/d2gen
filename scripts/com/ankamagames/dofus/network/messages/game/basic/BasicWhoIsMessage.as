package com.ankamagames.dofus.network.messages.game.basic
{
   ...
   public class BasicWhoIsMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.self));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.verbose));
         ...
         for(var _i10:int = 0; _i10 < this.socialGroups.length; _i10++)
         {
      ...
      public function deserializeAs_BasicWhoIsMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i10:int = 0; _i10 < _socialGroupsLen; _i10++)
         {
            _id10 = uint(input.readUnsignedShort());
