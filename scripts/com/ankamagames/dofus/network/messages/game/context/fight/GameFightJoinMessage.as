package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightJoinMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.isTeamPhase));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.canBeCancelled));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.canSayReady));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.isFightStarted));
