package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightResumeWithSlavesMessage extends GameFightResumeMessage implements INetworkMessage
   {
      ...
      public function initGameFightResumeWithSlavesMessage(effects:Vector.<FightDispellableEffectExtendedInformations> = null, marks:Vector.<GameActionMark> = null, gameTurn:uint = 0, fightStart:uint = 0, idols:Vector.<Idol> = null, spellCooldowns:Vector.<GameFightSpellCooldown> = null, summonCount:uint = 0, bombCount:uint = 0, slavesInfo:Vector.<GameFightResumeSlaveInfo> = null) : GameFightResumeWithSlavesMessage
      {
         super.initGameFightResumeMessage(effects,marks,gameTurn,fightStart,idols,spellCooldowns,summonCount,bombCount);
      ...
      public function serializeAs_GameFightResumeWithSlavesMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.slavesInfo.length; _i1++)
         {
      ...
      public function deserializeAs_GameFightResumeWithSlavesMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _slavesInfoLen; _i1++)
         {
