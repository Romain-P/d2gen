package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapComplementaryInformationsDataMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MapComplementaryInformationsDataMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < this.houses.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.actors.length; _i4++)
         {
         ...
         for(var _i5:int = 0; _i5 < this.interactiveElements.length; _i5++)
         {
      ...
      public function deserializeAs_MapComplementaryInformationsDataMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < _housesLen; _i3++)
         {
            _id3 = uint(input.readUnsignedShort());
         ...
         for(var _i4:int = 0; _i4 < _actorsLen; _i4++)
         {
            _id4 = uint(input.readUnsignedShort());
         ...
         for(var _i5:int = 0; _i5 < _interactiveElementsLen; _i5++)
         {
            _id5 = uint(input.readUnsignedShort());
         ...
         for(var _i6:int = 0; _i6 < _statedElementsLen; _i6++)
         {
         ...
         for(var _i7:int = 0; _i7 < _obstaclesLen; _i7++)
         {
         ...
         for(var _i8:int = 0; _i8 < _fightsLen; _i8++)
         {
