package com.ankamagames.dofus.network.messages.game.context.roleplay.quest
{
   ...
   public class QuestListMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_QuestListMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.finishedQuestsIds.length; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < this.finishedQuestsCounts.length; _i2++)
         {
         ...
         for(var _i3:int = 0; _i3 < this.activeQuests.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.reinitDoneQuestsIds.length; _i4++)
         {
      ...
      public function deserializeAs_QuestListMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _finishedQuestsIdsLen; _i1++)
         {
            _val1 = uint(input.readVarUhShort());
            if(_val1 < 0)
            {
         ...
         for(var _i2:int = 0; _i2 < _finishedQuestsCountsLen; _i2++)
         {
         ...
         for(var _i3:int = 0; _i3 < _activeQuestsLen; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < _reinitDoneQuestsIdsLen; _i4++)
         {
            _val4 = uint(input.readVarUhShort());
            if(_val4 < 0)
            {
