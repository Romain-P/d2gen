package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightSpectateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initGameFightSpectateMessage(effects:Vector.<FightDispellableEffectExtendedInformations> = null, marks:Vector.<GameActionMark> = null, gameTurn:uint = 0, fightStart:uint = 0, idols:Vector.<Idol> = null) : GameFightSpectateMessage
      {
      ...
      public function serializeAs_GameFightSpectateMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.effects.length; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < this.marks.length; _i2++)
         {
         ...
         for(var _i5:int = 0; _i5 < this.idols.length; _i5++)
         {
      ...
      public function deserializeAs_GameFightSpectateMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _effectsLen; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < _marksLen; _i2++)
         {
         ...
         for(var _i5:int = 0; _i5 < _idolsLen; _i5++)
         {
            _item5 = new Idol();
