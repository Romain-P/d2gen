package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightResumeMessage extends GameFightSpectateMessage implements INetworkMessage
   {
      ...
      public function initGameFightResumeMessage(effects:Vector.<FightDispellableEffectExtendedInformations> = null, marks:Vector.<GameActionMark> = null, gameTurn:uint = 0, fightStart:uint = 0, idols:Vector.<Idol> = null, spellCooldowns:Vector.<GameFightSpellCooldown> = null, summonCount:uint = 0, bombCount:uint = 0) : GameFightResumeMessage
      {
         super.initGameFightSpectateMessage(effects,marks,gameTurn,fightStart,idols);
      ...
      public function serializeAs_GameFightResumeMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.spellCooldowns.length; _i1++)
         {
      ...
      public function deserializeAs_GameFightResumeMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _spellCooldownsLen; _i1++)
         {
