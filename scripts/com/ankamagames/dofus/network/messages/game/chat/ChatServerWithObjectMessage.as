package com.ankamagames.dofus.network.messages.game.chat
{
   ...
   public class ChatServerWithObjectMessage extends ChatServerMessage implements INetworkMessage
   {
      ...
      public function initChatServerWithObjectMessage(channel:uint = 0, content:String = "", timestamp:uint = 0, fingerprint:String = "", senderId:Number = 0, senderName:String = "", senderAccountId:uint = 0, objects:Vector.<ObjectItem> = null) : ChatServerWithObjectMessage
      {
      ...
      public function serializeAs_ChatServerWithObjectMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.objects.length; _i1++)
         {
      ...
      public function deserializeAs_ChatServerWithObjectMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _objectsLen; _i1++)
         {
