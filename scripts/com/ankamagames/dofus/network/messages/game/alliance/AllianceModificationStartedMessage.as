package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class AllianceModificationStartedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.canChangeName));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.canChangeTag));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.canChangeEmblem));
