package com.ankamagames.dofus.network.messages.game.alliance
{
   ...
   public class KohUpdateMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_KohUpdateMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < this.alliances.length; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < this.allianceNbMembers.length; _i2++)
         {
         ...
         for(var _i3:int = 0; _i3 < this.allianceRoundWeigth.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.allianceMatchScore.length; _i4++)
         {
         ...
         for(var _i5:int = 0; _i5 < this.allianceMapWinners.length; _i5++)
         {
      ...
      public function deserializeAs_KohUpdateMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i1:int = 0; _i1 < _alliancesLen; _i1++)
         {
         ...
         for(var _i2:int = 0; _i2 < _allianceNbMembersLen; _i2++)
         {
            _val2 = uint(input.readVarUhShort());
            if(_val2 < 0)
            {
         ...
         for(var _i3:int = 0; _i3 < _allianceRoundWeigthLen; _i3++)
         {
            _val3 = uint(input.readVarUhInt());
            if(_val3 < 0)
            {
         ...
         for(var _i4:int = 0; _i4 < _allianceMatchScoreLen; _i4++)
         {
            _val4 = uint(input.readByte());
            if(_val4 < 0)
            {
         ...
         for(var _i5:int = 0; _i5 < _allianceMapWinnersLen; _i5++)
         {
