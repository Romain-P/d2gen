package com.ankamagames.dofus.network.messages.game.dare
{
   ...
   public class DareCreationRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.isPrivate));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.isForGuild));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.isForAlliance));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,3,this.needNotifications));
         ...
         for(var _i10:int = 0; _i10 < this.criterions.length; _i10++)
         {
      ...
      public function deserializeAs_DareCreationRequestMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i10:int = 0; _i10 < _criterionsLen; _i10++)
         {
