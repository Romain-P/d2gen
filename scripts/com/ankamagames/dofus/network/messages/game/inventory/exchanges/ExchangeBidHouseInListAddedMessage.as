package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeBidHouseInListAddedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initExchangeBidHouseInListAddedMessage(itemUID:int = 0, objGenericId:int = 0, effects:Vector.<ObjectEffect> = null, prices:Vector.<Number> = null) : ExchangeBidHouseInListAddedMessage
      {
      ...
      public function serializeAs_ExchangeBidHouseInListAddedMessage(output:ICustomDataOutput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < this.effects.length; _i3++)
         {
         ...
         for(var _i4:int = 0; _i4 < this.prices.length; _i4++)
         {
            if(this.prices[_i4] < 0 || this.prices[_i4] > 9007199254740990)
            {
               throw new Error("Forbidden value (" + this.prices[_i4] + ") on element 4 (starting at 1) of prices.");
            }
            output.writeVarLong(this.prices[_i4]);
         }
      }
      ...
      public function deserializeAs_ExchangeBidHouseInListAddedMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i4:int = 0; _i4 < _pricesLen; _i4++)
         {
            _val4 = input.readVarUhLong();
            if(_val4 < 0 || _val4 > 9007199254740990)
            {
