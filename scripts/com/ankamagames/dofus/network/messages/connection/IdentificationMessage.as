package com.ankamagames.dofus.network.messages.connection
{
   ...
   public class IdentificationMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initIdentificationMessage(version:VersionExtended = null, lang:String = "", credentials:Vector.<int> = null, serverId:int = 0, autoconnect:Boolean = false, useCertificate:Boolean = false, useLoginToken:Boolean = false, sessionOptionalSalt:Number = 0, failedAttempts:Vector.<uint> = null) : IdentificationMessage
      {
      ...
      {
         var _box0:* = 0;
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,0,this.autoconnect));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,1,this.useCertificate));
         _box0 = uint(BooleanByteWrapper.setFlag(_box0,2,this.useLoginToken));
         output.writeByte(_box0);
         this.version.serializeAs_VersionExtended(output);
         output.writeUTF(this.lang);
         output.writeVarInt(this.credentials.length);
         for(var _i3:int = 0; _i3 < this.credentials.length; _i3++)
         {
         ...
         for(var _i9:int = 0; _i9 < this.failedAttempts.length; _i9++)
         {
      ...
      public function deserializeAs_IdentificationMessage(input:ICustomDataInput) : void
      {
         ...
         for(var _i3:int = 0; _i3 < _credentialsLen; _i3++)
         {
         ...
         for(var _i9:int = 0; _i9 < _failedAttemptsLen; _i9++)
         {
            _val9 = uint(input.readVarUhShort());
            if(_val9 < 0)
            {
