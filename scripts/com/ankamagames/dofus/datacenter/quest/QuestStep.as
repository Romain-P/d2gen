package com.ankamagames.dofus.datacenter.quest
{
   ...
   public class QuestStep implements IDataCenter
   {
      ...
      public function get kamasReward() : Number
      {
         ...
         return this._currentLevelRewards == null?0:Number(this._currentLevelRewards.kamasReward);
      }
      
      public function get experienceReward() : uint
      {
         this.initCurrentLevelRewards();
         return this._currentLevelRewards == null?0:uint(this._currentLevelRewards.experienceReward);
      }
      ...
      {
         this.initCurrentLevelRewards();
         return this._currentLevelRewards == null?0:Number(this._currentLevelRewards.getKamasReward(pPlayerLevel));
      }
      
      public function getExperienceReward(pPlayerLevel:int, pXpBonus:int) : Number
      {
         this.initCurrentLevelRewards();
         return this._currentLevelRewards == null?0:Number(this._currentLevelRewards.getExperienceReward(pPlayerLevel,pXpBonus));
      }
