package com.ankamagames.dofus.datacenter.items
{
   ...
   public class Item implements IPostInit, IDataCenter
   {
      ...
      private var _itemSet:ItemSet#140;
      ...
      public static function getItemsByIds(ids:Array) : Array
      {
         var id:* = undefined;
         var items:* = [];
         for each(id in ids)
         {
            items.push(GameDataFileAccessor.getInstance().getObject(MODULE,id));
         }
         return items;
      }
      ...
      public function get itemSet() : ItemSet#140
      {
         if(!this._itemSet)
         {
            this._itemSet = ItemSet#140.getItemSetById(this.itemSetId);
         }
