package com.ankamagames.dofus.scripts.spells
{
   ...
   public class SpellScript2 extends SpellScriptBase
   {
      ...
      {
         var entryPortalCell:* = null;
         var exitPortalCell:* = null;
         var missileGfx:* = null;
         var addMissileGfxStep:* = null;
         var speed:* = NaN;
         var curvature:* = NaN;
         var missileOrientedToCurve:Boolean = false;
         var missileGfxYOffset:* = NaN;
         var missileStep:* = null;
         var destroyMissileStep:* = null;
         var missileGfx2:* = null;
         var addMissileGfxStep2:* = null;
         var missileStep2:* = null;
         var destroyMissileStep2:* = null;
         super(spellFxRunner);
         ...
         if(SpellFxApi.HasSpellParam(spell,"missileGfxId") && tmpTargetCell && caster)
         {
            ...
            {
               speed = Number((SpellFxApi.GetSpellParam(spell,"missileSpeed") + 10) * 10);
            }
            curvature = 0.5;
            if(SpellFxApi.HasSpellParam(spell,"missileCurvature"))
            {
               curvature = Number(SpellFxApi.GetSpellParam(spell,"missileCurvature") / 10);
            }
            ...
            {
               missileGfxYOffset = Number(SpellFxApi.GetSpellParam(spell,"missileGfxYOffset"));
            }
