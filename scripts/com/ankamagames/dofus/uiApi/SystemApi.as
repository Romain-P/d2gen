package com.ankamagames.dofus.uiApi
{
   ...
   public class SystemApi implements IApi
   {
      ...
      public function sendAction(action:Object) : uint
      {
         ...
         var classInfo:* = null;
         var t:* = 0;
         var needConfirmStoreDataManager:* = null;
         var commonMod:* = null;
         if(action.hasOwnProperty("parameters"))
         {
            ...
            if(!this._module.trusted)
            {
               ...
               {
                  t = uint(getTimer() - _actionTsRef[apiAction]);
      ...
      {
         return Capabilities.version.indexOf(" 10,0") != -1?1:uint(2);
      }
      ...
      public function getUrltoShareContent(content:Object, callback:Function, shareType:String = null) : void
      {
         ...
         HaapiKeyManager.getInstance().addEventListener(ApiKeyReadyEvent.READY,function(e:ApiKeyReadyEvent):void
         {
