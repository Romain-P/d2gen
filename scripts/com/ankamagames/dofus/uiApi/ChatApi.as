package com.ankamagames.dofus.uiApi
{
   ...
   public class ChatApi implements IApi
   {
      ...
      [Untrusted]
      public function newChatSentenceWithSource(id:uint, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, senderName:String = "", objects:Vector.<ItemWrapper> = null) : ChatSentenceWithSource
      {
      ...
      [Untrusted]
      public function newChatSentenceWithRecipient(id:uint, msg:String, channel:uint = 0, time:Number = 0, finger:String = "", senderId:Number = 0, senderName:String = "", receiverName:String = "", receiverId:Number = 0, objects:Vector.<ItemWrapper> = null) : ChatSentenceWithRecipient
      {
