package com.ankamagames.dofus.uiApi
{
   ...
   public class DataApi implements IApi
   {
      ...
      {
         return Notification#318.getNotifications();
      }
      ...
      [Untrusted]
      public function getItemsByIds(ids:Array) : Array
      {
      ...
      [Untrusted]
      public function getItemSet(id:int) : ItemSet#140
      {
         return ItemSet#140.getItemSetById(id);
      }
      ...
      [Untrusted]
      public function getSmiley(id:uint) : Smiley#98
      {
         return Smiley#98.getSmileyById(id);
      }
      
      [Untrusted]
      public function getAllSmiley() : Array
      {
         return Smiley#98.getSmileys();
      }
      ...
      public function getEvolutiveEffectInstancesByExperienceBoost(item:ItemWrapper, experienceBoost:int) : Array
      {
         ...
         var effect:* = null;
         if(experienceBoost == 0 || !item || item.evolutiveEffectIds.length == 0 || !item.type || !item.type.evolutiveType)
         {
            return [];
         }
