package com.ankamagames.dofus.uiApi
{
   ...
   public class AbstractItemFilterApi implements IApi
   {
      ...
      [Untrusted]
      public function initFilters(defaultTab:uint, characterInfos:*, currentTypeInfos:Dictionary, openedCategories:Array, filterList:Grid, itemList:Grid, specificType:Vector.<uint> = null) : void
      {
