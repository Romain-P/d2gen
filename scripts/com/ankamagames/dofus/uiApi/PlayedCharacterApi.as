package com.ankamagames.dofus.uiApi
{
   ...
   public class PlayedCharacterApi implements IApi
   {
      ...
      {
         super();
         MEMORY_LOG["[object PlayedCharacterApi]"] = 1;
         _instance = this;
      }
      ...
      {
         var obtentionSpellLevel:* = 0;
         var playerSpellLevel:* = 0;
         var sp:* = null;
         var disable:Boolean = false;
         var spellWrapper:* = null;
         var spellLevelZero:* = null;
         ...
         else
         {
            ...
            obtentionSpellLevel = uint(spellLevelZero.minPlayerLevel);
         }
         ...
         for each(sp in spellInv)
         {
            ...
            {
               playerSpellLevel = uint(sp.spellLevel);
            }
         }
         disable = true;
