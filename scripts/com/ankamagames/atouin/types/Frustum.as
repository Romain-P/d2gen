package com.ankamagames.atouin.types
{
   ...
   public class Frustum extends Rectangle
   {
      ...
      public function refresh() : void
      {
         ...
         {
            divX = Number((this._marginLeft + this._marginRight) / this._marginLeft);
         }
         else if(this._marginLeft)
         {
            divX = Number(2 + xSpace / this._marginLeft);
         }
         else if(this._marginRight)
         {
            divX = Number(2 - xSpace / this._marginRight);
         }
         else
         {
            divX = 2;
         ...
         {
            divY = Number((this._marginTop + this._marginBottom) / this._marginTop);
         }
         else if(this._marginTop)
         {
            divY = Number(2 + ySpace / this._marginTop);
         }
         else if(this._marginBottom)
         {
            divY = Number(ySpace / this._marginBottom - 2);
         }
         else
         {
            divY = 2;
