   ...
   public class CellReference
   {
      ...
      public function getAvgColor() : uint
      {
         ...
         for(i = 0; i < len; i = i + 1)
         {
            ...
            red = Number(red + t.redOffset * t.redMultiplier);
            green = Number(green + t.greenOffset * t.greenMultiplier);
            blue = Number(blue + t.blueOffset * t.blueMultiplier);
         }
         red = Number(red / len);
         green = Number(green / len);
         blue = Number(blue / len);
