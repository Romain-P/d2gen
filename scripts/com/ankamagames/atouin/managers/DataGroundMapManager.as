package com.ankamagames.atouin.managers
{
   ...
   public class DataGroundMapManager
   {
      ...
      private static function initEncoder(qualityEnum:uint) : void
      {
         ...
         {
            switch(qualityEnum == GroundCache.GROUND_CACHE_HIGH_QUALITY === true?0:qualityEnum == GroundCache.GROUND_CACHE_MEDIUM_QUALITY === true?1:qualityEnum == GroundCache.GROUND_CACHE_LOW_QUALITY === true?2:3)
            {
               case 0:
                  quality = uint(JPEG_HIGH_QUALITY);
                  break;
               case 1:
                  quality = uint(JPEG_MEDIUM_QUALITY);
                  break;
               case 2:
                  quality = uint(JPEG_LOW_QUALITY);
                  break;
               default:
                  quality = uint(JPEG_MEDIUM_QUALITY);
