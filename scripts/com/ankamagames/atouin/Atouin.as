package com.ankamagames.atouin
{
   ...
   public class Atouin
   {
      ...
      public function setDisplayOptions(ao:AtouinOptions) : void
      {
         ...
         for(var i:int = 0; i < this._worldContainer.numChildren; i++)
         {
         ...
         this.computeWideScreenBitmapWidth(ao.frustum);
         this.setWorldMaskDimensions(AtouinConstants.WIDESCREEN_BITMAP_WIDTH);
         var hideBlackBorderValue:Boolean = this._aoOptions.hideBlackBorder;
      ...
      {
         for(var i:int = 0; i < this._worldMask.numChildren; i++)
         {
      ...
      public function displayGrid(b:Boolean, pIsInFight:Boolean = false) : void
      {
         ...
         if(b != this.options.alwaysShowGrid)
         {
            this.options.alwaysShowGrid = b;
         }
      }
      ...
      public function zoom(value:Number, posX:int = 0, posY:int = 0) : void
      {
         ...
         else
         {
            ...
            {
               value = Number(AtouinConstants.MAX_ZOOM);
            }
      ...
      {
         if(map.zoomScale != 1 && this._aoOptions.useInsideAutoZoom)
         {
