package com.ankamagames.jerakine.utils.display
{
   ...
   public class EnterFrameDispatcher
   {
      ...
      public static function addEventListener(listener:Function, name:String, frameRate:uint = 4.294967295E9) : void
      {
         ...
         {
            _controledListeners[listener] = new ControledEnterFrameListener(name,listener,frameRate > 0?uint(1000 / frameRate):0,!!_listenerUp?uint(_currentTime):uint(getTimer()));
            if(!_listenerUp)
            {
      ...
      private static function onEnterFrame(e:Event) : void
      {
         ...
         {
            diff = uint(_currentTime - cefl.latestChange);
