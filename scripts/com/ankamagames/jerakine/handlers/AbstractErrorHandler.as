package com.ankamagames.jerakine.handlers
{
   ...
   public class AbstractErrorHandler
   {
      ...
      private static const RELEASE_SENTRY_CONFIG_URL:String = "http://dl.ak.ankama.com/games/dofus2/sentry/";
      
      private static const LOCAL_CYTRUS_URL:String = "http://cytrus.ankama.lan/cytrus.json";
      
      private static const RELEASE_CYTRUS_URL:String = "https://ankama.akamaized.net/zaap/cytrus/cytrus.json";
      ...
      protected static var _logBuffer:TemporaryBufferTarget;
      ...
      private static function createEmptyLog4As() : void
      {
      ...
      public function get isSentryInitialized() : Boolean
      {
      ...
      protected function initSentry(version:Version, environment:String, isLocal:Boolean) : void
      {
         ...
         var sentryVersion:String = version.toString(version.buildType != 0?this._environment:null);
      ...
      protected function getExtras() : Object
      {
         ...
         var logs:Array = _logBuffer.getBuffer();
         var logCount:int = 0;
         var logTail:Vector.<LogEvent> = new Vector.<LogEvent>(0);
         var i:int = logs.length - 1;
         while(i >= 0 && logCount < 100)
         {
            log = logs[i];
