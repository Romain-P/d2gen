package com.ankamagames.jerakine.replay
{
   ...
   public class LogFrame implements Frame
   {
      ...
      private var _currentRecursivityClassName:String;
      
      private var _recursivityStepCount:int;
      ...
      public static function set sendReplayInfo(v:Boolean) : void
      {
         ...
         _self._sendindLc.addEventListener(StatusEvent.STATUS,statusHandler);
      }
      ...
      private function getClassIndex(className:String) : int
      {
         ...
         if(className != this._currentRecursivityClassName)
         {
            this._currentRecursivityClassName = className;
            this._recursivityStepCount = 1;
         }
         else
         {
            this._recursivityStepCount++;
            if(this._recursivityStepCount > 100)
            {
               return 0;
            }
         }
