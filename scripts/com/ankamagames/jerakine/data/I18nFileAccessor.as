package com.ankamagames.jerakine.data
{
   ...
   public class I18nFileAccessor
   {
      ...
      public function init(fileUri:Uri) : void
      {
         ...
         for(var i:* = 0; i < indexesLength; i = uint(i + 9))
         {
         ...
         for(indexesLength = this._stream.readInt(); indexesLength > 0; )
         {
            position = uint(this._stream.position);
