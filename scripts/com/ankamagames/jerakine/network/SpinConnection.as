package com.ankamagames.jerakine.network
{
   ...
   public class SpinConnection
   {
      ...
      private function onData(event:ProgressEvent) : void
      {
         ...
         {
            length = uint(this._socket.readUnsignedInt());
            data = new ByteArray();
      ...
      {
         var start:* = null;
         var encryptionDetails:* = null;
         var authSuccess:* = null;
         var sessionCreationResult:* = null;
         switch(true)
         {
            case msg is Start:
               start = msg as Start;
      ...
      private function createAuthMessage(details:EncryptionDetails, args:Array) : Message
      {
         var rsa:* = null;
         var salt:* = null;
         var simplePassword:* = null;
         var simpleAuth:* = null;
         var login:* = null;
         var password:* = null;
         var loginBytes:* = null;
         var passwordBytes:* = null;
         var encryptedLogin:* = null;
         var encryptedPassword:* = null;
         var loginPasswordAuth:* = null;
         var token:* = null;
         var tokenBytes:* = null;
