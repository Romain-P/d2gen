package com.ankamagames.performance.tests
{
   ...
   public class TestDisplayPerformance implements IBenchmarkTest
   {
      ...
      public function run() : void
      {
         ...
         this._ctr.mouseChildren = false;
         this._ctr.mouseEnabled = false;
      ...
      private function onFrame(event:Event) : void
      {
         ...
         if(this._tickTime >= 500)
         {
            ...
            {
               l = uint(this._recordedFps.length);
      ...
      public function getResults() : String
      {
         ...
         if(_results)
         {
            ...
            {
               averageFps = Number(averageFps + _results[i]);
            }
            averageFps = Number(Math.floor(averageFps / _results.length));
