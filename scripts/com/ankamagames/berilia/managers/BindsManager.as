package com.ankamagames.berilia.managers
{
   ...
   public class BindsManager extends GenericEventsManager
   {
      ...
      public function getBind(s:Bind, returnDisabled:Boolean = false) : Bind
      {
         ...
         var i:int = -1;
         for(var num:int = this._aRegisterKey.length; ++i < num; )
         {
      ...
      {
         for(var i:int = 0; i < this._aRegisterKey.length; )
         {
      ...
      {
         for(var i:int = 0; i < ShortcutsEnum.BASIC_SHORTCUT_FORBIDDEN.length; )
         {
      ...
      public function newShortcut(shortcut:Shortcut) : void
      {
         var bind:* = null;
         var b:* = null;
         for(var i:int = 0; i < this._waitingBinds.length; )
         {
      ...
      private function parseBindsXml(sXml:String, removeOldbinds:Boolean) : void
      {
         ...
         if(init)
         {
            for(i = 0; i < this._aRegisterKey.length; )
            {
