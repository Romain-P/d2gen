package com.ankamagames.berilia.types.shortcut
{
   ...
   public class Shortcut implements IDataCenter
   {
      ...
      public function Shortcut(name:String, textfieldEnabled:Boolean = false, description:String = null, category:ShortcutCategory = null, bindable:Boolean = true, pVisible:Boolean = true, pRequired:Boolean = false, pHoldKeys:Boolean = false, tooltipContent:String = null, admin:Boolean = false)
      {
         super();
         if(_shortcuts[name])
         {
