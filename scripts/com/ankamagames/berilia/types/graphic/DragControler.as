   ...
   public class DragControler implements MessageHandler
   {
      ...
      public function restrictPosition() : void
      {
         ...
         if(!this._dragRestrictedArea.containsRect(this._currentBounds))
         {
            ...
            {
               this.targetContainer.yNoCache = targetParent.globalToLocal(new Point(0,32)).y;
            }
         }
      }
      ...
      {
         var ui:* = null;
         var screenMagnetWidth:int = 0;
         var screenMagnetheight:int = 0;
         var magneticElements:* = null;
         var gc:* = null;
      ...
      private function getMagneticResult(realBounds:Boolean = true) : Rectangle
      {
         ...
         var biggestCollisionAreaSurface:* = 0;
         var biggestCollisionArea:* = null;
         for each(mg in this._magneticUiRect)
         {
            ...
            {
               biggestCollisionAreaSurface = uint(collideZone.width * collideZone.height);
      ...
      private function getNewPosition(target:Rectangle, magneticArea:MagnetGrid) : Rectangle
      {
         ...
         {
            if(magneticArea.magnetX && this.horizontalDrag)
            {
         ...
         {
            if(magneticArea.magnetY && this.verticalDrag)
            {
