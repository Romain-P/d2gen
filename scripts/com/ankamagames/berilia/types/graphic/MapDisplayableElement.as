package com.ankamagames.berilia.types.graphic
{
   ...
   public class MapDisplayableElement extends MapElement
   {
      ...
      public function set textureWidth(v:Number) : void
      {
         if(this._texture)
         {
            this._texture.width = v;
         }
      }
      ...
      public function set textureHeight(v:Number) : void
      {
         if(this._texture)
         {
            this._texture.height = v;
         }
      }
      ...
      public function hasContainerAsTextureParent(container:DisplayObjectContainer) : Boolean
      {
         if(this._texture)
         {
            return container == this._texture.parent;
         }
         return false;
      }
