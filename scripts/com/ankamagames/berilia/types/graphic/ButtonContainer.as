         ...
         if(!this._disabled)
         {
            switch(true)
            {
               case msg is MouseDownMessage:
                  ...
                  tmpState = uint(!!this._selected?uint(StatesEnum.STATE_SELECTED_CLICKED):uint(StatesEnum.STATE_CLICKED));
                  break;
               ...
               case msg is MouseClickMessage:
                  ...
                  tmpState = uint(!!this._selected?uint(StatesEnum.STATE_SELECTED_OVER):uint(StatesEnum.STATE_OVER));
                  if(!changingStateData[tmpState])
                  {
                     tmpState = uint(!!this._selected?uint(StatesEnum.STATE_SELECTED):uint(StatesEnum.STATE_NORMAL));
                  }
                  if(!this.isMute)
                  {
