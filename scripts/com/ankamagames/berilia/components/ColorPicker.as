package com.ankamagames.berilia.components
{
   ...
   public class ColorPicker extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      override public function finalize() : void
      {
         ...
         this._aRatiosHue = new Array(0,42.5,85,127.5,170,212.5,255);
         this._mMatrixSaturation = new Matrix();
         this._mMatrixSaturation.createGradientBox(this._nGradientWidth,this._nHeight,0.5 * Math.PI,0,0);
         ...
         this._mMatrixSlider.createGradientBox(this._nSliderWidth,this._nHeight,0.5 * Math.PI,0,0);
      ...
      private function getCurrentColor() : uint
      {
         ...
         if(!this._bFixedColor)
         {
            ...
            tempColor = Number(Math.round((r2 << 16) + (g2 << 8) + b2));
         }
         else
         {
            tempColor = Number(this._nColor);
         }
