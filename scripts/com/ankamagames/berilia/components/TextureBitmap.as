package com.ankamagames.berilia.components
{
   ...
   public class TextureBitmap extends TextureBase implements FinalizableUIComponent
   {
      ...
      override public function set useCache(value:Boolean) : void
      {
         super.useCache = value;
      }
      ...
      public function set align(str:String) : void
      {
         ...
         var validAlign:* = [null,"TOPLEFT","TOP","TOPRIGHT","LEFT","CENTER","RIGHT","BOTTOMLEFT","BOTTOM","BOTTOMRIGHT"];
      ...
      private function drawFit() : void
      {
         ...
         if(usedWidth < 0)
         {
            xOffset = Number(usedWidth);
         }
         if(usedHeight < 0)
         {
            yOffset = Number(usedHeight);
         }
      ...
      function drawErrorTexture() : void
      {
         ...
         graphics.drawRect(0,0,width != 0?Number(width):10,height != 0?Number(height):Number(10));
         graphics.endFill();
      }
