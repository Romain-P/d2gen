         ...
         if(!behavior.cancel && ree.uri == _uri)
         {
            ...
            if(ree.uri == _uri)
            {
               ...
               if(_showLoadingError)
               {
                  ...
                  shp.graphics.drawRect(0,0,!isNaN(this._forcedWidth) && this._forcedWidth != 0?Number(this._forcedWidth):10,!isNaN(this._forcedHeight) && this._forcedHeight != 0?Number(this._forcedHeight):Number(10));
