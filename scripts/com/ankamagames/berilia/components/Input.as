package com.ankamagames.berilia.components
{
   ...
   public class Input extends Label implements UIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#1503>;
      ...
      public function Input()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#1503>(0);
      ...
      private function addHistory(pText:String) : void
      {
         ...
         var entry:InputEntry = new InputEntry#1503(pText,hyperlinkCodes);
      ...
      private function onTimerFormatDelay(e:TimerEvent) : void
      {
         ...
         if(toInt && !isNaN(toInt))
         {
            ...
            for(i = 0; i < newStringWithSpaces.length - 1; )
            {
...
class InputEntry#1503
{
   ...
   function InputEntry#1503(pText:String, pHyperlinkCodes:Vector.<String>)
   {
      super();
      this._text = pText;
