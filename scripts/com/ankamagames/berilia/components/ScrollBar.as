package com.ankamagames.berilia.components
{
   ...
   public class ScrollBar extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      {
         var stateChangingProperties1:* = null;
         var stateChangingProperties2:* = null;
         var stateChangingProperties3:* = null;
         if(!this._gcBox)
         {
      ...
      private function scrollBarProcess() : void
      {
         ...
         if(this._texMax)
         {
            if(!this._texMax.finalized)
            {
               ...
               this._gcMax.x = !!this._bVertical?0:Number(this._nWidth - arrowEdge);
         ...
         if(!this._texBox.finalized || !this._gcBox.parent)
         {
            ...
            this._gcBox.x = !!this._bVertical?0:Number(this._nCurrentPos);
