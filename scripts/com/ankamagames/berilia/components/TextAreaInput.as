package com.ankamagames.berilia.components
{
   ...
   public class TextAreaInput extends TextArea implements FinalizableUIComponent
   {
      ...
      private var _inputHistory:Vector.<InputEntry#6563>;
      ...
      public function TextAreaInput()
      {
         ...
         this._inputHistory = new Vector.<InputEntry#6563>(0);
      ...
      private function addHistory(pText:String) : void
      {
         ...
         var entry:InputEntry = new InputEntry#6563(pText,hyperlinkCodes);
...
class InputEntry#6563
{
   ...
   function InputEntry#6563(pText:String, pHyperlinkCodes:Vector.<String>)
   {
      super();
      this._text = pText;
