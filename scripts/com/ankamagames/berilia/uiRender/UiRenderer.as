package com.ankamagames.berilia.uiRender
{
   ...
   public class UiRenderer extends EventDispatcher
   {
      ...
      public function UiRenderer()
      {
         ...
         super();
         MEMORY_LOG["[object UiRenderer]"] = 1;
      }
      ...
      {
         for(var i:int = 0; i < this._aFilnalizedLater.length; i++)
         {
      ...
      private function makeModalContainer() : void
      {
         ...
         var sizeX:int = StageShareManager.stage.nativeWindow.maxSize.x * StageShareManager.stage.nativeWindow.maxSize.x;
         var sizeY:int = StageShareManager.stage.nativeWindow.maxSize.y * StageShareManager.stage.nativeWindow.maxSize.y;
