package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class FieldDescriptor_TYPE_STRING extends FieldDescriptor
   {
       
      
      public function FieldDescriptor_TYPE_STRING(fullName:String, name:String, tag:uint)
      {
         super();
