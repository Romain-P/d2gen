package com.ankama.chat
{
   ...
   public final dynamic class DeleteGroup extends Message
   {
      
      public static const UID:String = "40A110DE-7ED6-4E93-9BAC-DD41110DFF7C";
      
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.DeleteGroup.group","group",8 | WireType.LENGTH_DELIMITED);
         ...
         while(input.bytesAvailable > bytesAfterSlice)
         {
            ...
            switch(tag >> 3)
            {
               case 1:
                  if(group$count != 0)
                  {
                     throw new IOError("Bad data format: DeleteGroup.group cannot be set twice.");
                  }
                  group$count++;
