package com.ankama.chat
{
   ...
   public final dynamic class FriendRemoved extends Message
   {
      
      public static const UID:String = "03DAF116-3355-4084-9071-68FC59670E1B";
      
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendRemoved.friend","friend",8 | WireType.LENGTH_DELIMITED);
         ...
         while(input.bytesAvailable > bytesAfterSlice)
         {
            ...
            switch(tag >> 3)
            {
               case 1:
                  if(friend$count != 0)
                  {
                     throw new IOError("Bad data format: FriendRemoved.friend cannot be set twice.");
                  }
                  friend$count++;
