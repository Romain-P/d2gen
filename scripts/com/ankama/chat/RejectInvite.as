package com.ankama.chat
{
   ...
   public final dynamic class RejectInvite extends Message
   {
      ...
      public static const FROMUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.RejectInvite.fromUser","fromUser",8 | WireType.LENGTH_DELIMITED);
