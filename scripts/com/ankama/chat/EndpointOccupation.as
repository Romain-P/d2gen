package com.ankama.chat
{
   ...
   public final dynamic class EndpointOccupation extends Message
   {
      ...
      public static const APPID:FieldDescriptor_TYPE_INT32 = new FieldDescriptor_TYPE_INT32("com.ankama.chat.EndpointOccupation.appId","appId",8 | WireType.VARINT);
      
      public static const OCCUPATION:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.EndpointOccupation.occupation","occupation",16 | WireType.LENGTH_DELIMITED);
      ...
      {
         var tag:* = 0;
         var appId$count:int = 0;
         var occupation$count:int = 0;
