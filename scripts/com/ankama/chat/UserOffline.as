package com.ankama.chat
{
   ...
   public final dynamic class UserOffline extends Message
   {
      
      public static const UID:String = "01478CE1-B3B0-4EB6-A32A-C4E8DDE8CDC6";
      
      public static const USER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.UserOffline.user","user",8 | WireType.LENGTH_DELIMITED);
         ...
         while(input.bytesAvailable > bytesAfterSlice)
         {
            ...
            switch(tag >> 3)
            {
               case 1:
                  if(user$count != 0)
                  {
                     throw new IOError("Bad data format: UserOffline.user cannot be set twice.");
                  }
                  user$count++;
