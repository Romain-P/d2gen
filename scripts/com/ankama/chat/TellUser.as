package com.ankama.chat
{
   ...
   public final dynamic class TellUser extends Message
   {
      ...
      public static const MESSAGE:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.TellUser.message","message",8 | WireType.LENGTH_DELIMITED);
      
      public static const TARGETUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.TellUser.targetUser","targetUser",16 | WireType.LENGTH_DELIMITED);
      ...
      {
         var tag:* = 0;
         var message$count:int = 0;
         var targetUser$count:int = 0;
