package com.ankama.chat
{
   ...
   public final dynamic class FriendGroupSet extends Message
   {
      ...
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendGroupSet.friend","friend",8 | WireType.LENGTH_DELIMITED);
      
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendGroupSet.group","group",16 | WireType.LENGTH_DELIMITED);
