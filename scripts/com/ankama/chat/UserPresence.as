package com.ankama.chat
{
   ...
   public final dynamic class UserPresence extends Message
   {
      ...
      public static const USER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.UserPresence.user","user",8 | WireType.LENGTH_DELIMITED);
      
      public static const OCCUPATION:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("com.ankama.chat.UserPresence.occupation","occupation",16 | WireType.VARINT,UserOccupation);
