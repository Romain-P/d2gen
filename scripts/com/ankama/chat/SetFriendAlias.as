package com.ankama.chat
{
   ...
   public final dynamic class SetFriendAlias extends Message
   {
      ...
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.SetFriendAlias.friend","friend",8 | WireType.LENGTH_DELIMITED);
      
      public static const ALIAS:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.SetFriendAlias.alias","alias",16 | WireType.LENGTH_DELIMITED);
