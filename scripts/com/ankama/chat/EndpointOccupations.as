package com.ankama.chat
{
   ...
   public final dynamic class EndpointOccupations extends Message
   {
      ...
      public static const USER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.EndpointOccupations.user","user",8 | WireType.LENGTH_DELIMITED);
      
      public static const OCCUPATIONS:RepeatedFieldDescriptor_TYPE_MESSAGE = new RepeatedFieldDescriptor_TYPE_MESSAGE("com.ankama.chat.EndpointOccupations.occupations","occupations",16 | WireType.LENGTH_DELIMITED,function():Class
      {
      ...
      override final function writeToBuffer(output:WritingBuffer) : void
      {
         ...
         for(var occupations$index:int = 0; occupations$index < this.occupations.length; occupations$index++)
         {
