package com.ankama.chat
{
   ...
   public final dynamic class IgnoreSet extends Message
   {
      ...
      public static const USER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.IgnoreSet.user","user",8 | WireType.LENGTH_DELIMITED);
      
      public static const IGNORE:FieldDescriptor_TYPE_BOOL = new FieldDescriptor_TYPE_BOOL("com.ankama.chat.IgnoreSet.ignore","ignore",16 | WireType.VARINT);
