package com.ankama.chat
{
   ...
   public final dynamic class FriendAliasSet extends Message
   {
      ...
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendAliasSet.friend","friend",8 | WireType.LENGTH_DELIMITED);
      
      public static const ALIAS:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.FriendAliasSet.alias","alias",16 | WireType.LENGTH_DELIMITED);
