package com.ankama.chat
{
   ...
   public final dynamic class SetFriendGroup extends Message
   {
      ...
      public static const FRIEND:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.SetFriendGroup.friend","friend",8 | WireType.LENGTH_DELIMITED);
      
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.SetFriendGroup.group","group",16 | WireType.LENGTH_DELIMITED);
