package com.ankama.chat
{
   ...
   public final dynamic class SetEndpointOccupation extends Message
   {
      ...
      public static const OCCUPATION:FieldDescriptor_TYPE_MESSAGE = new FieldDescriptor_TYPE_MESSAGE("com.ankama.chat.SetEndpointOccupation.occupation","occupation",8 | WireType.LENGTH_DELIMITED,function():Class
      {
