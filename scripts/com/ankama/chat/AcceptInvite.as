package com.ankama.chat
{
   ...
   public final dynamic class AcceptInvite extends Message
   {
      ...
      public static const FROMUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.AcceptInvite.fromUser","fromUser",8 | WireType.LENGTH_DELIMITED);
