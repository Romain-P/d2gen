package com.ankama.chat
{
   ...
   public final dynamic class UserMessage extends Message
   {
      ...
      public static const MESSAGE:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.UserMessage.message","message",8 | WireType.LENGTH_DELIMITED);
      
      public static const FROMUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.UserMessage.fromUser","fromUser",16 | WireType.LENGTH_DELIMITED);
