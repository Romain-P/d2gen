package com.ankama.chat
{
   ...
   public final dynamic class InviteRejected extends Message
   {
      ...
      public static const FROMUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.InviteRejected.fromUser","fromUser",8 | WireType.LENGTH_DELIMITED);
      
      public static const TOUSER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.InviteRejected.toUser","toUser",16 | WireType.LENGTH_DELIMITED);
