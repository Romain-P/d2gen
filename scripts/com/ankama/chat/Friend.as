package com.ankama.chat
{
   ...
   public final dynamic class Friend extends Message
   {
      ...
      public static const USER:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.Friend.user","user",8 | WireType.LENGTH_DELIMITED);
      
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.Friend.group","group",16 | WireType.LENGTH_DELIMITED);
      
      public static const ALIAS:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.Friend.alias","alias",24 | WireType.LENGTH_DELIMITED);
      ...
      {
         var tag:* = 0;
         var user$count:int = 0;
         var group$count:int = 0;
         var alias$count:int = 0;
