package com.ankama.chat
{
   ...
   public final dynamic class AddGroup extends Message
   {
      ...
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.AddGroup.group","group",8 | WireType.LENGTH_DELIMITED);
