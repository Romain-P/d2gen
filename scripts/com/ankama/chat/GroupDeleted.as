package com.ankama.chat
{
   ...
   public final dynamic class GroupDeleted extends Message
   {
      
      public static const UID:String = "E1723A7B-E722-454F-8DBE-97E32A7AD5A5";
      
      public static const GROUP:FieldDescriptor_TYPE_STRING = new FieldDescriptor_TYPE_STRING("com.ankama.chat.GroupDeleted.group","group",8 | WireType.LENGTH_DELIMITED);
         ...
         while(input.bytesAvailable > bytesAfterSlice)
         {
            ...
            switch(tag >> 3)
            {
               case 1:
                  if(group$count != 0)
                  {
                     throw new IOError("Bad data format: GroupDeleted.group cannot be set twice.");
                  }
                  group$count++;
