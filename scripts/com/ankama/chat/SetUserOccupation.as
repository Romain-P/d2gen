package com.ankama.chat
{
   ...
   public final dynamic class SetUserOccupation extends Message
   {
      ...
      public static const OCCUPATION:FieldDescriptor_TYPE_ENUM = new FieldDescriptor_TYPE_ENUM("com.ankama.chat.SetUserOccupation.occupation","occupation",8 | WireType.VARINT,UserOccupation);
